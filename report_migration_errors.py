...
def main():
    ...
    for row in rows:
        ...
        if cuer_npers_juri:
            try:
                cuer_npers_juri_num = int(cuer_npers_juri.replace('.', '').replace('N°', ''))
