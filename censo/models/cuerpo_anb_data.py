...
class CuerpoANBData(models.Model):
    ...
    cuerpo_brigada_juvenil_antiquity = models.IntegerField(null=True, blank=True, verbose_name='Antigüedad')
    ...
    cuerpo_brigada_juvenil_responsible_role = models.CharField(max_length=255, null=True, blank=True, verbose_name='Cargo Instructor responsable')
    cuerpo_brigada_juvenil_responsible_nombre = models.CharField(max_length=255, null=True, blank=True, verbose_name='Nombre Instructor responsable')
