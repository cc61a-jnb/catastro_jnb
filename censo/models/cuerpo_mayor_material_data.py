...
class CuerpoMayorMaterialData(models.Model):
    ...
    fk_condition = models.ForeignKey('Condition', verbose_name='Estado/Condición', null=True, blank=False)
    ...
    fk_incorporation_status = models.ForeignKey('IncorporationStatus', verbose_name='Estado de incorporación', null=True, blank=False)
    previous_owner = models.CharField(max_length=255, null=True, blank=True, verbose_name='Propietario anterior')
    fk_color = models.ForeignKey('Color', verbose_name='Color', null=True, blank=False)
    ...
    fk_transmission_type = models.ForeignKey('TransmissionType', verbose_name='Tipo de caja de cambio', null=True, blank=False)
    # motor_type/Tipo de motor se refiere a la pregunta de "Combustible" de la ficha original
    motor_type = models.ForeignKey('MotorType', verbose_name='Tipo de motor (Combustible)', null=True, blank=False)
    fk_procedence = models.ForeignKey('VehicleProcedence', verbose_name='Procedencia', null=True, blank=False)
    ...
    fk_vehicle_registration = models.ForeignKey('VehicleRegistrationStatus', verbose_name='Permiso de Circulación', null=True, blank=False)
    # Revision tecnica -> Opciones: Al dia, Vencida, No tiene
    fk_vehicle_checkup = models.ForeignKey('VehicleCheckupStatus', verbose_name='Revisión Técnica', null=True, blank=False)
    ...
    fk_fire_engine_camiva_model = models.ForeignKey('FireEngineCamivaModel', verbose_name='Camiva', null=True, blank=False)
