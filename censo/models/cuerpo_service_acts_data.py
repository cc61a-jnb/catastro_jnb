...
class CuerpoServiceActsData(models.Model):
    ...
    outdoors_fire_quantity = models.IntegerField(null=True, blank=True, help_text="Ej: Pastizales, plantaciónes agricolas, parques nacionales, microbasurales, desechos, vertederos o bienes de uso público.", verbose_name='Fuego en áreas abiertas')
    ...
    incidents_explosive_materials_quantity = models.IntegerField(null=True, blank=True, help_text="Ej: Explosivos, gases, líquidos, solidos, comburentes, peróxidos organicos, venenos liquidos o sólidos, radioactivos o corrosivos.",  verbose_name='f. Control de fuego que involucre materiales peligrosos')
    ...
    revision_inspection_quantity =models.IntegerField(null=True, blank=True,  help_text="Ej: Peritajes, revisión de edificios, inspección de local comercial, industrias, grifos, simulacros.", verbose_name='j.Servicios de inspección y revisión')
