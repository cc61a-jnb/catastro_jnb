...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.second_last_lane'
        db.delete_column('censo_userprofile', 'second_last_lane')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserProfile.second_last_lane'
        db.add_column('censo_userprofile', 'second_last_lane', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)
