...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CuerpoInfrastructureData'
        db.create_table('censo_cuerpoinfrastructuredata', (
            ('terrain_machine_room_m2', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('bathrooms', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('barrack_house', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('building_initial_construction_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('supervisor_office', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('fk_property_title_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PropertyTitleType'], null=True)),
            ('building_initial_construction_legal', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('built_area_surface_m2', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('major_office', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ...
            ('general_treasurer_office', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ...
            ('general_secretary_office', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ...
        db.send_create_signal('censo', ['CuerpoInfrastructureData'])

        # Adding M2M table for field building_material_type on 'CuerpoInfrastructureData'
        db.create_table('censo_cuerpoinfrastructuredata_building_material_type', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cuerpoinfrastructuredata', models.ForeignKey(orm['censo.cuerpoinfrastructuredata'], null=False)),
            ('buildingmaterialtype', models.ForeignKey(orm['censo.buildingmaterialtype'], null=False))
        ))
        db.create_unique('censo_cuerpoinfrastructuredata_building_material_type', ['cuerpoinfrastructuredata_id', 'buildingmaterialtype_id'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CuerpoInfrastructureData'
        db.delete_table('censo_cuerpoinfrastructuredata')

        # Removing M2M table for field building_material_type on 'CuerpoInfrastructureData'
        db.delete_table('censo_cuerpoinfrastructuredata_building_material_type')
