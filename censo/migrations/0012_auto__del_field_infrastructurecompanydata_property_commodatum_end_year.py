...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfrastructureCompanyData.property_commodatum_end_year'
        db.delete_column('censo_infrastructurecompanydata', 'property_commodatum_end_year')

        # Adding field 'InfrastructureCompanyData.property_rental_commodatum_end_year'
        db.add_column('censo_infrastructurecompanydata', 'property_rental_commodatum_end_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'InfrastructureCompanyData.property_commodatum_end_year'
        db.add_column('censo_infrastructurecompanydata', 'property_commodatum_end_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'InfrastructureCompanyData.property_rental_commodatum_end_year'
        db.delete_column('censo_infrastructurecompanydata', 'property_rental_commodatum_end_year')
    ...
    models = {
        ...
        'censo.antennaequipment': {
            'Meta': {'ordering': "['manufacturer', 'model']", 'object_name': 'AntennaEquipment'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'censo.baseradioequipment': {
            'Meta': {'ordering': "['manufacturer', 'model']", 'object_name': 'BaseRadioEquipment'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manufacturer': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'minor_material_company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.MinorMaterialCompanyData']", 'null': 'True', 'blank': 'True'}),
            'model': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'censo.portableradioequipment': {
            'Meta': {'ordering': "['manufacturer', 'model']", 'object_name': 'PortableRadioEquipment'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manufacturer': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'minor_material_company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.MinorMaterialCompanyData']", 'null': 'True', 'blank': 'True'}),
            'model': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
