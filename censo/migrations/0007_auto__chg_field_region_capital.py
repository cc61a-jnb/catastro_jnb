...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Region.capital'
        db.alter_column('censo_region', 'capital_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Commune'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Region.capital'
        db.alter_column('censo_region', 'capital_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Commune']))
