...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfrastructureCompanyData.property_title_type'
        db.delete_column('censo_infrastructurecompanydata', 'property_title_type')

        # Adding field 'InfrastructureCompanyData.fk_property_title_type'
        db.add_column('censo_infrastructurecompanydata', 'fk_property_title_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PropertyTitleType'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'InfrastructureCompanyData.property_title_type'
        db.add_column('censo_infrastructurecompanydata', 'property_title_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'InfrastructureCompanyData.fk_property_title_type'
        db.delete_column('censo_infrastructurecompanydata', 'fk_property_title_type_id')
    ...
    models = {
        ...
        'censo.infrastructurecompanydata': {
            ...
            'building_material_type_other': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'terrain_session_room_m2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
