...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompanyOtherRadioBase'
        db.create_table('censo_companyotherradiobase', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Company'])),
            ('radio_brand', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('radio_model', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('censo', ['CompanyOtherRadioBase'])


    def backwards(self, orm):
        
        # Deleting model 'CompanyOtherRadioBase'
        db.delete_table('censo_companyotherradiobase')
