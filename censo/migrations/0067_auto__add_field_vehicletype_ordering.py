...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VehicleType.ordering'
        db.add_column('censo_vehicletype', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VehicleType.ordering'
        db.delete_column('censo_vehicletype', 'ordering')
    ...
    models = {
        ...
        'censo.company': {
            'Meta': {'ordering': "['cuerpo', 'number']", 'object_name': 'Company'},
        ...
        'censo.companyantenas': {
            'Meta': {'ordering': "['id']", 'object_name': 'CompanyAntenas'},
        ...
        'censo.companyotherradiobase': {
            'Meta': {'ordering': "['id']", 'object_name': 'CompanyOtherRadioBase'},
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.Company']"}),
        ...
        'censo.companyotherradioportable': {
            'Meta': {'ordering': "['id']", 'object_name': 'CompanyOtherRadioPortable'},
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.Company']"}),
        ...
        'censo.cuerpoalarmcentraldata': {
            ...
            'fk_portable_manufacturer1': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'null': 'True', 'to': "orm['censo.PortableBrand']"}),
            'fk_portable_manufacturer2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'null': 'True', 'to': "orm['censo.PortableBrand']"}),
            'fk_portable_manufacturer3': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'null': 'True', 'to': "orm['censo.PortableBrand']"}),
        ...
        'censo.cuerpoinfrastructureotheroffices': {
            'Meta': {'ordering': "['id']", 'object_name': 'CuerpoInfrastructureOtherOffices'},
            'cuerpo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.Cuerpo']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'role_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        'censo.cuerpomaterialmayorantenna': {
            'Meta': {'ordering': "['id']", 'object_name': 'CuerpoMaterialMayorAntenna'},
        ...
        'censo.cuerpomaterialmayorinstalledradio': {
            'Meta': {'ordering': "['id']", 'object_name': 'CuerpoMaterialMayorInstalledRadio'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'censo.cuerpomaterialmayorportableradio': {
            'Meta': {'ordering': "['id']", 'object_name': 'CuerpoMaterialMayorPortableRadio'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material_mayor_data': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.CuerpoMayorMaterialData']"}),
        ...
        'censo.cuerpomayormaterialdata': {
            'Meta': {'ordering': "['cuerpo', 'id']", 'object_name': 'CuerpoMayorMaterialData'},
            ...
            'fk_electricgenerator_fixed_in_barracks_potency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'null': 'True', 'to': "orm['censo.PotencyRange']"}),
            'fk_electricgenerator_fixed_in_car_potency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'null': 'True', 'to': "orm['censo.PotencyRange']"}),
            'fk_electricgenerator_portable_potency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'blank': 'True', 'null': 'True', 'to': "orm['censo.PotencyRange']"}),
        ...
        'censo.portablebrand': {
            'Meta': {'ordering': "['ordering', 'name']", 'object_name': 'PortableBrand'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        ...
        'censo.potencyrange': {
            'Meta': {'ordering': "['ordering', 'name']", 'object_name': 'PotencyRange'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'censo.propertytitletype': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'requires_end_year': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'censo.province': {
        ...
        'censo.vehiclecarrosadomanufacturer': {
            'Meta': {'ordering': "['name']", 'object_name': 'VehicleCarrosadoManufacturer'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'censo.vehiclechassismanufacturer': {
            'Meta': {'ordering': "['name']", 'object_name': 'VehicleChassisManufacturer'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        'censo.vehicletype': {
            'Meta': {'ordering': "['ordering', 'name']", 'object_name': 'VehicleType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
