...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MinorMaterialCompanyData.fk_electricgenerator_portable_potency'
        db.delete_column('censo_minormaterialcompanydata', 'fk_electricgenerator_portable_potency_id')

        # Deleting field 'MinorMaterialCompanyData.electricgenerator_fixed_in_car_quantity'
        db.delete_column('censo_minormaterialcompanydata', 'electricgenerator_fixed_in_car_quantity')

        # Deleting field 'MinorMaterialCompanyData.electricgenerator_portable_quantity'
        db.delete_column('censo_minormaterialcompanydata', 'electricgenerator_portable_quantity')

        # Deleting field 'MinorMaterialCompanyData.fk_electricgenerator_fixed_in_car_potency'
        db.delete_column('censo_minormaterialcompanydata', 'fk_electricgenerator_fixed_in_car_potency_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'MinorMaterialCompanyData.fk_electricgenerator_portable_potency'
        db.add_column('censo_minormaterialcompanydata', 'fk_electricgenerator_portable_potency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['censo.PotencyRange'], blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.electricgenerator_fixed_in_car_quantity'
        db.add_column('censo_minormaterialcompanydata', 'electricgenerator_fixed_in_car_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.electricgenerator_portable_quantity'
        db.add_column('censo_minormaterialcompanydata', 'electricgenerator_portable_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.fk_electricgenerator_fixed_in_car_potency'
        db.add_column('censo_minormaterialcompanydata', 'fk_electricgenerator_fixed_in_car_potency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['censo.PotencyRange'], blank=True), keep_default=False)
