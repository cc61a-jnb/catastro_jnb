...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Color.ordering'
        db.add_column('censo_color', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'IncorporationStatus.ordering'
        db.add_column('censo_incorporationstatus', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Color.ordering'
        db.delete_column('censo_color', 'ordering')

        # Deleting field 'IncorporationStatus.ordering'
        db.delete_column('censo_incorporationstatus', 'ordering')
