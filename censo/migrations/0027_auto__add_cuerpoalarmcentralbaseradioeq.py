...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CuerpoAlarmCentralBaseRadioEq'
        db.create_table('censo_cuerpoalarmcentralbaseradioeq', (
        ...
        db.send_create_signal('censo', ['CuerpoAlarmCentralBaseRadioEq'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CuerpoAlarmCentralBaseRadioEq'
        db.delete_table('censo_cuerpoalarmcentralbaseradioeq')
