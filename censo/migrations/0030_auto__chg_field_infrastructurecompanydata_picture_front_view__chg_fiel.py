...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfrastructureCompanyData.picture_front_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_front_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'InfrastructureCompanyData.picture_internal_distribution_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_internal_distribution_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'InfrastructureCompanyData.picture_machine_room_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_machine_room_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'InfrastructureCompanyData.picture_general_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_general_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'InfrastructureCompanyData.picture_back_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_back_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'InfrastructureCompanyData.picture_office_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_office_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'InfrastructureCompanyData.picture_front_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_front_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'InfrastructureCompanyData.picture_internal_distribution_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_internal_distribution_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'InfrastructureCompanyData.picture_machine_room_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_machine_room_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'InfrastructureCompanyData.picture_general_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_general_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'InfrastructureCompanyData.picture_back_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_back_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'InfrastructureCompanyData.picture_office_view'
        db.alter_column('censo_infrastructurecompanydata', 'picture_office_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
