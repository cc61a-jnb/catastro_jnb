...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoAlarmCentralData.fixed_antenna_height2'
        db.add_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_height2', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_model3'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_model3', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.fixed_antenna_model1'
        db.add_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_model1', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.fixed_antenna_model2'
        db.add_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_model2', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_power2'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_power2', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_power3'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_power3', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_power1'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_power1', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.fixed_antenna_quantity1'
        db.add_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_quantity1', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.fixed_antenna_quantity2'
        db.add_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_quantity2', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.fixed_antenna_height1'
        db.add_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_height1', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_manufacturer3'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_manufacturer3', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_manufacturer2'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_manufacturer2', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_manufacturer1'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_manufacturer1', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.fixed_antenna_manufacturer1'
        db.add_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_manufacturer1', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.fixed_antenna_manufacturer2'
        db.add_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_manufacturer2', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.fixed_antenna_decibel1'
        db.add_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_decibel1', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.fixed_antenna_decibel2'
        db.add_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_decibel2', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_model2'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_model2', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_model1'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_model1', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_quantity3'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_quantity3', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_quantity2'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_quantity2', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.portable_quantity1'
        db.add_column('censo_cuerpoalarmcentraldata', 'portable_quantity1', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'CuerpoAlarmCentralData.fk_bandwidth'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_bandwidth_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.BandWidth'], null=True, blank=True))

        # Changing field 'CuerpoAlarmCentralData.fk_origin_software'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_origin_software_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.OriginSystem'], null=True, blank=True))

        # Changing field 'CuerpoAlarmCentralData.fk_vhf'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_vhf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.VHF'], null=True, blank=True))

        # Changing field 'CuerpoAlarmCentralData.fk_os'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_os_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.OperatingSystem'], null=True, blank=True))

        # Changing field 'CuerpoAlarmCentralData.fk_normalized_frequency'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_normalized_frequency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.NormalizedFrequency'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'CuerpoAlarmCentralData.fixed_antenna_height2'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_height2')

        # Deleting field 'CuerpoAlarmCentralData.portable_model3'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_model3')

        # Deleting field 'CuerpoAlarmCentralData.fixed_antenna_model1'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_model1')

        # Deleting field 'CuerpoAlarmCentralData.fixed_antenna_model2'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_model2')

        # Deleting field 'CuerpoAlarmCentralData.portable_power2'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_power2')

        # Deleting field 'CuerpoAlarmCentralData.portable_power3'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_power3')

        # Deleting field 'CuerpoAlarmCentralData.portable_power1'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_power1')

        # Deleting field 'CuerpoAlarmCentralData.fixed_antenna_quantity1'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_quantity1')

        # Deleting field 'CuerpoAlarmCentralData.fixed_antenna_quantity2'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_quantity2')

        # Deleting field 'CuerpoAlarmCentralData.fixed_antenna_height1'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_height1')

        # Deleting field 'CuerpoAlarmCentralData.portable_manufacturer3'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_manufacturer3')

        # Deleting field 'CuerpoAlarmCentralData.portable_manufacturer2'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_manufacturer2')

        # Deleting field 'CuerpoAlarmCentralData.portable_manufacturer1'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_manufacturer1')

        # Deleting field 'CuerpoAlarmCentralData.fixed_antenna_manufacturer1'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_manufacturer1')

        # Deleting field 'CuerpoAlarmCentralData.fixed_antenna_manufacturer2'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_manufacturer2')

        # Deleting field 'CuerpoAlarmCentralData.fixed_antenna_decibel1'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_decibel1')

        # Deleting field 'CuerpoAlarmCentralData.fixed_antenna_decibel2'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fixed_antenna_decibel2')

        # Deleting field 'CuerpoAlarmCentralData.portable_model2'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_model2')

        # Deleting field 'CuerpoAlarmCentralData.portable_model1'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_model1')

        # Deleting field 'CuerpoAlarmCentralData.portable_quantity3'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_quantity3')

        # Deleting field 'CuerpoAlarmCentralData.portable_quantity2'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_quantity2')

        # Deleting field 'CuerpoAlarmCentralData.portable_quantity1'
        db.delete_column('censo_cuerpoalarmcentraldata', 'portable_quantity1')

        # Changing field 'CuerpoAlarmCentralData.fk_bandwidth'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_bandwidth_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.BandWidth'], null=True))

        # Changing field 'CuerpoAlarmCentralData.fk_origin_software'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_origin_software_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.OriginSystem'], null=True))

        # Changing field 'CuerpoAlarmCentralData.fk_vhf'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_vhf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.VHF'], null=True))

        # Changing field 'CuerpoAlarmCentralData.fk_os'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_os_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.OperatingSystem'], null=True))

        # Changing field 'CuerpoAlarmCentralData.fk_normalized_frequency'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_normalized_frequency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.NormalizedFrequency'], null=True))
    ...
    models = {
        ...
        'censo.cuerpoalarmcentraldata': {
            ...
            'fk_bandwidth': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.BandWidth']", 'null': 'True', 'blank': 'True'}),
            ...
            'fk_normalized_frequency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.NormalizedFrequency']", 'null': 'True', 'blank': 'True'}),
            ...
            'portable_manufacturer1': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'portable_manufacturer2': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'portable_manufacturer3': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
