...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CuerpoAlarmCentralData.frequency_two'
        db.alter_column('censo_cuerpoalarmcentraldata', 'frequency_two', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=3))

        # Changing field 'CuerpoAlarmCentralData.frequency_three'
        db.alter_column('censo_cuerpoalarmcentraldata', 'frequency_three', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=3))
        ...
        # Changing field 'CuerpoAlarmCentralData.frequency_four'
        db.alter_column('censo_cuerpoalarmcentraldata', 'frequency_four', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=3))


    def backwards(self, orm):
        
        # Changing field 'CuerpoAlarmCentralData.frequency_two'
        db.alter_column('censo_cuerpoalarmcentraldata', 'frequency_two', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CuerpoAlarmCentralData.frequency_three'
        db.alter_column('censo_cuerpoalarmcentraldata', 'frequency_three', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CuerpoAlarmCentralData.frequency_one'
        db.alter_column('censo_cuerpoalarmcentraldata', 'frequency_one', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CuerpoAlarmCentralData.frequency_four'
        db.alter_column('censo_cuerpoalarmcentraldata', 'frequency_four', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'censo.cuerpoalarmcentraldata': {
            ...
            'frequency_one': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '6', 'decimal_places': '3', 'blank': 'True'}),
