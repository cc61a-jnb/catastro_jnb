...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('censo_cuerpomayormaterialdata', 'fk_electricgenerator_portable_potency', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['censo.PotencyRange']), keep_default=False)
        ...
        db.add_column('censo_cuerpomayormaterialdata', 'fk_electricgenerator_fixed_in_barracks_potency', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['censo.PotencyRange']), keep_default=False)
        ...
        db.add_column('censo_cuerpomayormaterialdata', 'fk_electricgenerator_fixed_in_car_potency', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['censo.PotencyRange']), keep_default=False)
    ...
    models = {
        ...
        'censo.companyotherradiobase': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.Company']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'radio_brand': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'censo.companyotherradioportable': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.Company']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'radio_portable_brand': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'radio_portable_model': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'radio_portable_power': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'})
        },
        'censo.condition': {
        ...
        'censo.cuerpomayormaterialdata': {
            ...
            'vehicle_checkup': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'vehicle_registration': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
