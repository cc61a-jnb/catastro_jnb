...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('censo_infrastructurecompanydata', 'terrain_session_room_m2', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)
