...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AccountingSystem'
        db.create_table('censo_accountingsystem', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['AccountingSystem'])

        # Adding model 'CuerpoGeneralData'
        db.create_table('censo_cuerpogeneraldata', (
            ('personnel_management', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('social_other_account_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('personnel_guard', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('accounting_system_other_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('personnel_mechanic', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('personnel_cleaning', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('personnel_junior', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('personnel_secretary', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('personnel_accounting', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fk_accounting_system', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.AccountingSystem'], null=True)),
            ('personnel_alarm_central_op', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('computers_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('personnel_driver', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('projectors_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('censo', ['CuerpoGeneralData'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'AccountingSystem'
        db.delete_table('censo_accountingsystem')

        # Deleting model 'CuerpoGeneralData'
        db.delete_table('censo_cuerpogeneraldata')
