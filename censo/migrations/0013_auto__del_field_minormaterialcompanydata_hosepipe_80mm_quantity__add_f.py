...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MinorMaterialCompanyData.hosepipe_80mm_quantity'
        db.delete_column('censo_minormaterialcompanydata', 'hosepipe_80mm_quantity')

        # Adding field 'MinorMaterialCompanyData.hosepipe_70mm_quantity'
        db.add_column('censo_minormaterialcompanydata', 'hosepipe_70mm_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'MinorMaterialCompanyData.hosepipe_80mm_quantity'
        db.add_column('censo_minormaterialcompanydata', 'hosepipe_80mm_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'MinorMaterialCompanyData.hosepipe_70mm_quantity'
        db.delete_column('censo_minormaterialcompanydata', 'hosepipe_70mm_quantity')
