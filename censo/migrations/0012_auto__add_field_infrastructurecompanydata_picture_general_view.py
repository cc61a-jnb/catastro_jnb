...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfrastructureCompanyData.picture_general_view'
        db.add_column('censo_infrastructurecompanydata', 'picture_general_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'InfrastructureCompanyData.picture_general_view'
        db.delete_column('censo_infrastructurecompanydata', 'picture_general_view')
