...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('censo_userprofile', 'region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Region'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.region'
        db.delete_column('censo_userprofile', 'region_id')
