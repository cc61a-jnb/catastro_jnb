...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CuerpoANBData'
        db.create_table('censo_cuerpoanbdata', (
            ('cuerpo_courses_infrastructure_rcp', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_brigada_juvenil_responsible_role', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('cuerpo_brigada_juvenil_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('cuerpo_brigada_juvenil_responsible_email', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('anb_procedure_instructors', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_brigada_juvenil_members_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_specialty_instructors', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_brigada_juvenil_antiquity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('observations', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('cuerpo_health_instructors', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_courses_infrastructure_transparencies', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_courses_infrastructure_boards', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('anb_specialty_instructors', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_courses_infrastructure_diapositives', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['censo.Cuerpo'], unique=True, blank=True)),
            ('cuerpo_courses_infrastructure_datashow', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_courses_infrastructure_video', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_courses_infrastructure_amplifiers', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_brigada_juvenil_responsible_nombre', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('anb_health_instructors', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_courses_infrastructure_tvs', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_procedure_instructors', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_courses_infrastructure_rooms', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cuerpo_courses_infrastructure_telon', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('censo', ['CuerpoANBData'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CuerpoANBData'
        db.delete_table('censo_cuerpoanbdata')
