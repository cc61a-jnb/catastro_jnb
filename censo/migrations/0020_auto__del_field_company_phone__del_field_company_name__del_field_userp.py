...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('censo_company', 'name')
        ...
        db.delete_column('censo_userprofile', 'first_name')

        # Deleting field 'UserProfile.work_phone'
        db.delete_column('censo_userprofile', 'work_phone')

        # Deleting field 'UserProfile.gender'
        db.delete_column('censo_userprofile', 'gender')

        # Deleting field 'UserProfile.second_last_name'
        db.delete_column('censo_userprofile', 'second_last_name')

        # Deleting field 'UserProfile.phone'
        db.delete_column('censo_userprofile', 'phone')

        # Deleting field 'UserProfile.rut'
        db.delete_column('censo_userprofile', 'rut')

        # Deleting field 'UserProfile.work_address'
        db.delete_column('censo_userprofile', 'work_address')

        # Deleting field 'UserProfile.address'
        db.delete_column('censo_userprofile', 'address')

        # Deleting field 'UserProfile.cell_phone'
        db.delete_column('censo_userprofile', 'cell_phone')

        # Deleting field 'UserProfile.first_last_name'
        db.delete_column('censo_userprofile', 'first_last_name')

        # Deleting field 'UserProfile.current_role'
        db.delete_column('censo_userprofile', 'current_role_id')

        # Deleting field 'UserProfile.occupation'
        db.delete_column('censo_userprofile', 'occupation_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('censo_company', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
        ...
        db.add_column('censo_userprofile', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'UserProfile.work_phone'
        db.add_column('censo_userprofile', 'work_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)

        # Adding field 'UserProfile.gender'
        db.add_column('censo_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(default=datetime.date(2011, 5, 9), max_length=1), keep_default=False)

        # Adding field 'UserProfile.second_last_name'
        db.add_column('censo_userprofile', 'second_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)

        # Adding field 'UserProfile.phone'
        db.add_column('censo_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)

        # Adding field 'UserProfile.rut'
        db.add_column('censo_userprofile', 'rut', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'UserProfile.work_address'
        db.add_column('censo_userprofile', 'work_address', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'UserProfile.address'
        db.add_column('censo_userprofile', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'UserProfile.cell_phone'
        db.add_column('censo_userprofile', 'cell_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)

        # Adding field 'UserProfile.first_last_name'
        db.add_column('censo_userprofile', 'first_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)

        # Adding field 'UserProfile.current_role'
        db.add_column('censo_userprofile', 'current_role', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['censo.Role'], blank=True), keep_default=False)

        # Adding field 'UserProfile.occupation'
        db.add_column('censo_userprofile', 'occupation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Occupation'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'censo.company': {
            'Meta': {'ordering': "['old_id']", 'object_name': 'Company'},
