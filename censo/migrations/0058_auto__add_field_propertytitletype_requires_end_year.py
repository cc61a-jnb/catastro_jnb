...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PropertyTitleType.requires_end_year'
        db.add_column('censo_propertytitletype', 'requires_end_year', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'PropertyTitleType.requires_end_year'
        db.delete_column('censo_propertytitletype', 'requires_end_year')
