...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('censo_volunteerdata', 'volunteer_brigada_juvenil_responsible_email', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, blank=True))

        # Changing field 'VolunteerData.observations'
        db.alter_column('censo_volunteerdata', 'observations', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
