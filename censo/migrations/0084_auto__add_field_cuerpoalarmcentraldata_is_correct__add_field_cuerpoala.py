...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoAlarmCentralData.is_correct'
        db.add_column('censo_cuerpoalarmcentraldata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.is_complete'
        db.add_column('censo_cuerpoalarmcentraldata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.is_complete'
        db.add_column('censo_portadacuerpodata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.is_correct'
        db.add_column('censo_portadacuerpodata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoGeneralData.is_correct'
        db.add_column('censo_cuerpogeneraldata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoGeneralData.is_complete'
        db.add_column('censo_cuerpogeneraldata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoInfrastructureData.is_correct'
        db.add_column('censo_cuerpoinfrastructuredata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoInfrastructureData.is_complete'
        db.add_column('censo_cuerpoinfrastructuredata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.is_complete'
        db.add_column('censo_cuerposerviceactsdata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.is_correct'
        db.add_column('censo_cuerposerviceactsdata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoANBData.is_correct'
        db.add_column('censo_cuerpoanbdata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoANBData.is_complete'
        db.add_column('censo_cuerpoanbdata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.is_correct'
        db.add_column('censo_cuerpomayormaterialdata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.is_complete'
        db.add_column('censo_cuerpomayormaterialdata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CuerpoAlarmCentralData.is_correct'
        db.delete_column('censo_cuerpoalarmcentraldata', 'is_correct')

        # Deleting field 'CuerpoAlarmCentralData.is_complete'
        db.delete_column('censo_cuerpoalarmcentraldata', 'is_complete')

        # Deleting field 'PortadaCuerpoData.is_complete'
        db.delete_column('censo_portadacuerpodata', 'is_complete')

        # Deleting field 'PortadaCuerpoData.is_correct'
        db.delete_column('censo_portadacuerpodata', 'is_correct')

        # Deleting field 'CuerpoGeneralData.is_correct'
        db.delete_column('censo_cuerpogeneraldata', 'is_correct')

        # Deleting field 'CuerpoGeneralData.is_complete'
        db.delete_column('censo_cuerpogeneraldata', 'is_complete')

        # Deleting field 'CuerpoInfrastructureData.is_correct'
        db.delete_column('censo_cuerpoinfrastructuredata', 'is_correct')

        # Deleting field 'CuerpoInfrastructureData.is_complete'
        db.delete_column('censo_cuerpoinfrastructuredata', 'is_complete')

        # Deleting field 'CuerpoServiceActsData.is_complete'
        db.delete_column('censo_cuerposerviceactsdata', 'is_complete')

        # Deleting field 'CuerpoServiceActsData.is_correct'
        db.delete_column('censo_cuerposerviceactsdata', 'is_correct')

        # Deleting field 'CuerpoANBData.is_correct'
        db.delete_column('censo_cuerpoanbdata', 'is_correct')

        # Deleting field 'CuerpoANBData.is_complete'
        db.delete_column('censo_cuerpoanbdata', 'is_complete')

        # Deleting field 'CuerpoMayorMaterialData.is_correct'
        db.delete_column('censo_cuerpomayormaterialdata', 'is_correct')

        # Deleting field 'CuerpoMayorMaterialData.is_complete'
        db.delete_column('censo_cuerpomayormaterialdata', 'is_complete')
    ...
    models = {
        ...
        'censo.companyantenas': {
            'Meta': {'object_name': 'CompanyAntenas'},
            'antennas_manufacturer': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'antennas_model': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'antennas_power': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'antennas_quantity': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.Company']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'censo.companyelectgeneratorfixedbarracks': {
            'Meta': {'object_name': 'CompanyElectGeneratorFixedBarracks'},
            'fk_potency': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['censo.PotencyRange']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'infrastructure': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.InfrastructureCompanyData']"}),
        ...
        'censo.companyotherradiobase': {
            'Meta': {'object_name': 'CompanyOtherRadioBase'},
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.Company']"}),
            'fk_radio_brand': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.PortableBrand']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'radio_model': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'radio_power': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'radio_quantity': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'})
        },
        'censo.companyotherradioportable': {
            'Meta': {'object_name': 'CompanyOtherRadioPortable'},
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.Company']"}),
            'fk_radio_portable_brand': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.PortableBrand']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'radio_portable_model': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'radio_portable_quantity': ('django.db.models.fields.IntegerField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'})
        },
        'censo.condition': {
        ...
        'censo.cuerpoelectgeneratorfixedbarracks': {
            'Meta': {'object_name': 'CuerpoElectGeneratorFixedBarracks'},
            'fk_potency': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['censo.PotencyRange']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'infrastructure': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.CuerpoInfrastructureData']"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        'censo.cuerpomaterialmayorantenna': {
            'Meta': {'object_name': 'CuerpoMaterialMayorAntenna'},
            'antenna_brand': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'antenna_decibel': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'antenna_model': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'antenna_quantity': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material_mayor_data': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.CuerpoMayorMaterialData']"})
        },
        'censo.cuerpomaterialmayorgeneratorfixed': {
            'Meta': {'object_name': 'CuerpoMaterialMayorGeneratorFixed'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material_mayor_data': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.CuerpoMayorMaterialData']"}),
            'potency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.PotencyRange']"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {})
        },
        'censo.cuerpomaterialmayorgeneratorport': {
            'Meta': {'object_name': 'CuerpoMaterialMayorGeneratorPort'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material_mayor_data': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.CuerpoMayorMaterialData']"}),
            'potency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.PotencyRange']"}),
            'quantity': ('django.db.models.fields.IntegerField', [], {})
        },
        'censo.cuerpomaterialmayorinstalledradio': {
            'Meta': {'object_name': 'CuerpoMaterialMayorInstalledRadio'},
            'fk_installed_radio_brand': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.PortableBrand']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'installed_radio_model': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'installed_radio_potency': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'installed_radio_quantity': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'material_mayor_data': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.CuerpoMayorMaterialData']"})
        },
        'censo.cuerpomaterialmayorportableradio': {
            'Meta': {'object_name': 'CuerpoMaterialMayorPortableRadio'},
            'fk_portable_radio_brand': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.PortableBrand']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material_mayor_data': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.CuerpoMayorMaterialData']"}),
            'portable_radio_model': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'portable_radio_quantity': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'})
        },
        'censo.cuerpomayormaterialdata': {
            ...
            'carrosado_manufacturer_other': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'chassis_number': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'chassis_or_truck_manufacturer_other': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.Company']", 'null': 'True', 'blank': 'True'}),
            'cuerpo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.Cuerpo']"}),
            'cuerpo_vehicle_own': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'fk_carrosado_manufacturer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.VehicleCarrosadoManufacturer']", 'null': 'True', 'blank': 'True'}),
            'fk_chassis_or_truck_manufacturer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.VehicleChassisManufacturer']", 'null': 'True', 'blank': 'True'}),
            ...
            'gearbox_repairs': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'motor_repairs': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'picture_back_view': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture_front_view': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'picture_side_view': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'vehicle_checkup': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'vehicle_registration': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'vehicle_year': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        ...
        'censo.propertytitletype': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'requires_end_year': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
        'censo.province': {
        ...
        'censo.vehiclecarrosadomanufacturer': {
            'Meta': {'object_name': 'VehicleCarrosadoManufacturer'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'censo.vehiclechassismanufacturer': {
            'Meta': {'object_name': 'VehicleChassisManufacturer'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
