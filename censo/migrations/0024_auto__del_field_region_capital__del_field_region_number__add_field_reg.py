...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Region.old_id'
        db.add_column('censo_region', 'old_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Commune.url'
        db.delete_column('censo_commune', 'url')

        # Adding field 'Commune.old_id'
        db.add_column('censo_commune', 'old_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Region.capital'
        db.add_column('censo_region', 'capital', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Commune'], null=True, blank=True), keep_default=False)
        ...
        # Deleting field 'Region.old_id'
        db.delete_column('censo_region', 'old_id')

        # Adding field 'Commune.url'
        db.add_column('censo_commune', 'url', self.gf('django.db.models.fields.CharField')(default=0, max_length=100), keep_default=False)

        # Deleting field 'Commune.old_id'
        db.delete_column('censo_commune', 'old_id')
