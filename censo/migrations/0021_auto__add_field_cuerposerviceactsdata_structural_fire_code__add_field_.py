...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoServiceActsData.structural_fire_code'
        db.add_column('censo_cuerposerviceactsdata', 'structural_fire_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.structural_fire_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'structural_fire_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.vehicles_fire_code'
        db.add_column('censo_cuerposerviceactsdata', 'vehicles_fire_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.vehicles_fire_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'vehicles_fire_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.outdoors_fire_code'
        db.add_column('censo_cuerposerviceactsdata', 'outdoors_fire_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.outdoors_fire_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'outdoors_fire_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.rescue_victims_vehicles_code'
        db.add_column('censo_cuerposerviceactsdata', 'rescue_victims_vehicles_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.rescue_victims_vehicles_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'rescue_victims_vehicles_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.rescue_victims_not_vehicles_code'
        db.add_column('censo_cuerposerviceactsdata', 'rescue_victims_not_vehicles_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.rescue_victims_not_vehicles_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'rescue_victims_not_vehicles_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.incidents_explosive_materials_code'
        db.add_column('censo_cuerposerviceactsdata', 'incidents_explosive_materials_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.incidents_explosive_materials_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'incidents_explosive_materials_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.incidents_combustible_gases_code'
        db.add_column('censo_cuerposerviceactsdata', 'incidents_combustible_gases_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.incidents_combustible_gases_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'incidents_combustible_gases_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.electrical_emergency_code'
        db.add_column('censo_cuerposerviceactsdata', 'electrical_emergency_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.electrical_emergency_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'electrical_emergency_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.other_emergencies_code'
        db.add_column('censo_cuerposerviceactsdata', 'other_emergencies_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.other_emergencies_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'other_emergencies_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.revision_inspection_code'
        db.add_column('censo_cuerposerviceactsdata', 'revision_inspection_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.revision_inspection_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'revision_inspection_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.debris_removal_code'
        db.add_column('censo_cuerposerviceactsdata', 'debris_removal_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.debris_removal_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'debris_removal_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.support_other_cuerpos_code'
        db.add_column('censo_cuerposerviceactsdata', 'support_other_cuerpos_code', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.support_other_cuerpos_quantity'
        db.add_column('censo_cuerposerviceactsdata', 'support_other_cuerpos_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CuerpoServiceActsData.structural_fire_code'
        db.delete_column('censo_cuerposerviceactsdata', 'structural_fire_code')

        # Deleting field 'CuerpoServiceActsData.structural_fire_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'structural_fire_quantity')

        # Deleting field 'CuerpoServiceActsData.vehicles_fire_code'
        db.delete_column('censo_cuerposerviceactsdata', 'vehicles_fire_code')

        # Deleting field 'CuerpoServiceActsData.vehicles_fire_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'vehicles_fire_quantity')

        # Deleting field 'CuerpoServiceActsData.outdoors_fire_code'
        db.delete_column('censo_cuerposerviceactsdata', 'outdoors_fire_code')

        # Deleting field 'CuerpoServiceActsData.outdoors_fire_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'outdoors_fire_quantity')

        # Deleting field 'CuerpoServiceActsData.rescue_victims_vehicles_code'
        db.delete_column('censo_cuerposerviceactsdata', 'rescue_victims_vehicles_code')

        # Deleting field 'CuerpoServiceActsData.rescue_victims_vehicles_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'rescue_victims_vehicles_quantity')

        # Deleting field 'CuerpoServiceActsData.rescue_victims_not_vehicles_code'
        db.delete_column('censo_cuerposerviceactsdata', 'rescue_victims_not_vehicles_code')

        # Deleting field 'CuerpoServiceActsData.rescue_victims_not_vehicles_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'rescue_victims_not_vehicles_quantity')

        # Deleting field 'CuerpoServiceActsData.incidents_explosive_materials_code'
        db.delete_column('censo_cuerposerviceactsdata', 'incidents_explosive_materials_code')

        # Deleting field 'CuerpoServiceActsData.incidents_explosive_materials_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'incidents_explosive_materials_quantity')

        # Deleting field 'CuerpoServiceActsData.incidents_combustible_gases_code'
        db.delete_column('censo_cuerposerviceactsdata', 'incidents_combustible_gases_code')

        # Deleting field 'CuerpoServiceActsData.incidents_combustible_gases_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'incidents_combustible_gases_quantity')

        # Deleting field 'CuerpoServiceActsData.electrical_emergency_code'
        db.delete_column('censo_cuerposerviceactsdata', 'electrical_emergency_code')

        # Deleting field 'CuerpoServiceActsData.electrical_emergency_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'electrical_emergency_quantity')

        # Deleting field 'CuerpoServiceActsData.other_emergencies_code'
        db.delete_column('censo_cuerposerviceactsdata', 'other_emergencies_code')

        # Deleting field 'CuerpoServiceActsData.other_emergencies_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'other_emergencies_quantity')

        # Deleting field 'CuerpoServiceActsData.revision_inspection_code'
        db.delete_column('censo_cuerposerviceactsdata', 'revision_inspection_code')

        # Deleting field 'CuerpoServiceActsData.revision_inspection_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'revision_inspection_quantity')

        # Deleting field 'CuerpoServiceActsData.debris_removal_code'
        db.delete_column('censo_cuerposerviceactsdata', 'debris_removal_code')

        # Deleting field 'CuerpoServiceActsData.debris_removal_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'debris_removal_quantity')

        # Deleting field 'CuerpoServiceActsData.support_other_cuerpos_code'
        db.delete_column('censo_cuerposerviceactsdata', 'support_other_cuerpos_code')

        # Deleting field 'CuerpoServiceActsData.support_other_cuerpos_quantity'
        db.delete_column('censo_cuerposerviceactsdata', 'support_other_cuerpos_quantity')
    ...
    models = {
        ...
        'censo.accountingsystem': {
            'Meta': {'ordering': "['ordering', 'name']", 'object_name': 'AccountingSystem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'censo.buildingmaterialtype': {
            'Meta': {'ordering': "['ordering', 'name']", 'object_name': 'BuildingMaterialType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        ...
        'censo.commune': {
            'Meta': {'ordering': "['name']", 'object_name': 'Commune'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'censo.companyotherofficial': {
            'Meta': {'ordering': "['id']", 'object_name': 'CompanyOtherOfficial'},
        ...
        'censo.cuerpo': {
            'Meta': {'ordering': "['name']", 'object_name': 'Cuerpo'},
            'address': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
        ...
        'censo.cuerpoanbdata': {
            'Meta': {'ordering': "['cuerpo']", 'object_name': 'CuerpoANBData'},
        ...
        'censo.cuerpogeneraldata': {
            'Meta': {'ordering': "['cuerpo']", 'object_name': 'CuerpoGeneralData'},
        ...
        'censo.cuerpoinfrastructuredata': {
            'Meta': {'ordering': "['cuerpo']", 'object_name': 'CuerpoInfrastructureData'},
        ...
        'censo.cuerpomayormaterialdata': {
            'Meta': {'ordering': "['cuerpo']", 'object_name': 'CuerpoMayorMaterialData'},
            ...
            'gearbox_repairs': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'motor_repairs': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'censo.cuerpootherofficial': {
            'Meta': {'ordering': "['id']", 'object_name': 'CuerpoOtherOfficial'},
        ...
        'censo.cuerposerviceactsdata': {
            'Meta': {'ordering': "['cuerpo']", 'object_name': 'CuerpoServiceActsData'},
            'cuerpo': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['censo.Cuerpo']", 'unique': 'True', 'blank': 'True'}),
            'debris_removal_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'debris_removal_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'electrical_emergency_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'electrical_emergency_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incidents_combustible_gases_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'incidents_combustible_gases_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'incidents_explosive_materials_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'incidents_explosive_materials_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'observations': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'other_emergencies_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'other_emergencies_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'outdoors_fire_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'outdoors_fire_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'rescue_victims_not_vehicles_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'rescue_victims_not_vehicles_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'rescue_victims_vehicles_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'rescue_victims_vehicles_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'revision_inspection_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'revision_inspection_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'structural_fire_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'structural_fire_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'support_other_cuerpos_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'support_other_cuerpos_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'vehicles_fire_code': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'vehicles_fire_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'censo.fireenginecamivamodel': {
            'Meta': {'ordering': "['name']", 'object_name': 'FireEngineCamivaModel'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'censo.incorporationstatus': {
            'Meta': {'ordering': "['name']", 'object_name': 'IncorporationStatus'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'censo.infrastructurecompanydata': {
            'Meta': {'ordering': "['company']", 'object_name': 'InfrastructureCompanyData'},
        ...
        'censo.internetprovider': {
            'Meta': {'ordering': "['ordering', 'name']", 'object_name': 'InternetProvider'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'censo.minormaterialcompanydata': {
            'Meta': {'ordering': "['company']", 'object_name': 'MinorMaterialCompanyData'},
        ...
        'censo.motortype': {
            'Meta': {'ordering': "['name']", 'object_name': 'MotorType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'censo.occupation': {
            'Meta': {'ordering': "['name']", 'object_name': 'Occupation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'})
        },
        ...
        'censo.transmissiontype': {
            'Meta': {'ordering': "['name']", 'object_name': 'TransmissionType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'censo.userhasrole': {
            'Meta': {'ordering': "['profile', 'role']", 'object_name': 'UserHasRole'},
        ...
        'censo.vehiclecheckupstatus': {
            'Meta': {'ordering': "['name']", 'object_name': 'VehicleCheckupStatus'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'censo.vehicleprocedence': {
            'Meta': {'ordering': "['name']", 'object_name': 'VehicleProcedence'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'censo.vehicleregistrationstatus': {
            'Meta': {'ordering': "['name']", 'object_name': 'VehicleRegistrationStatus'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'censo.vehicletype': {
            'Meta': {'ordering': "['name']", 'object_name': 'VehicleType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'censo.volunteerdata': {
            'Meta': {'ordering': "['company']", 'object_name': 'VolunteerData'},
            'company': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['censo.Company']", 'unique': 'True', 'blank': 'True'}),
            'computers_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'fk_internet_provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.InternetProvider']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
