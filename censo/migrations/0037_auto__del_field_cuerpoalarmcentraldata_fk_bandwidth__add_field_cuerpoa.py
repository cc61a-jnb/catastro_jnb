...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CuerpoAlarmCentralData.fk_bandwidth'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fk_bandwidth_id')

        # Adding field 'CuerpoAlarmCentralData.bandwidth'
        db.add_column('censo_cuerpoalarmcentraldata', 'bandwidth', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CuerpoAlarmCentralData.fk_bandwidth'
        db.add_column('censo_cuerpoalarmcentraldata', 'fk_bandwidth', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['censo.BandWidth']), keep_default=False)

        # Deleting field 'CuerpoAlarmCentralData.bandwidth'
        db.delete_column('censo_cuerpoalarmcentraldata', 'bandwidth')
