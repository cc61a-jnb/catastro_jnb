...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VehicleChassisManufacturer.ordering'
        db.add_column('censo_vehiclechassismanufacturer', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VehicleChassisManufacturer.ordering'
        db.delete_column('censo_vehiclechassismanufacturer', 'ordering')
