...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CuerpoMayorMaterialData.fk_electricgenerator_portable_potency'
        db.delete_column('censo_cuerpomayormaterialdata', 'fk_electricgenerator_portable_potency_id')

        # Deleting field 'CuerpoMayorMaterialData.electricgenerator_fixed_in_barracks_quantity'
        db.delete_column('censo_cuerpomayormaterialdata', 'electricgenerator_fixed_in_barracks_quantity')

        # Deleting field 'CuerpoMayorMaterialData.electricgenerator_fixed_in_car_quantity'
        db.delete_column('censo_cuerpomayormaterialdata', 'electricgenerator_fixed_in_car_quantity')

        # Deleting field 'CuerpoMayorMaterialData.fk_electricgenerator_fixed_in_barracks_potency'
        db.delete_column('censo_cuerpomayormaterialdata', 'fk_electricgenerator_fixed_in_barracks_potency_id')

        # Deleting field 'CuerpoMayorMaterialData.electricgenerator_portable_quantity'
        db.delete_column('censo_cuerpomayormaterialdata', 'electricgenerator_portable_quantity')

        # Deleting field 'CuerpoMayorMaterialData.fk_electricgenerator_fixed_in_car_potency'
        db.delete_column('censo_cuerpomayormaterialdata', 'fk_electricgenerator_fixed_in_car_potency_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'CuerpoMayorMaterialData.fk_electricgenerator_portable_potency'
        db.add_column('censo_cuerpomayormaterialdata', 'fk_electricgenerator_portable_potency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['censo.PotencyRange'], blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.electricgenerator_fixed_in_barracks_quantity'
        db.add_column('censo_cuerpomayormaterialdata', 'electricgenerator_fixed_in_barracks_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.electricgenerator_fixed_in_car_quantity'
        db.add_column('censo_cuerpomayormaterialdata', 'electricgenerator_fixed_in_car_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.fk_electricgenerator_fixed_in_barracks_potency'
        db.add_column('censo_cuerpomayormaterialdata', 'fk_electricgenerator_fixed_in_barracks_potency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['censo.PotencyRange'], blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.electricgenerator_portable_quantity'
        db.add_column('censo_cuerpomayormaterialdata', 'electricgenerator_portable_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.fk_electricgenerator_fixed_in_car_potency'
        db.add_column('censo_cuerpomayormaterialdata', 'fk_electricgenerator_fixed_in_car_potency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['censo.PotencyRange'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'censo.cuerpomaterialmayorinstalledradio': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'installed_radio_brand': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'censo.cuerpomaterialmayorportableradio': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'material_mayor_data': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.CuerpoMayorMaterialData']"}),
            'portable_radio_brand': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
