...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cuerpo.second_commander_name'
        db.add_column('censo_cuerpo', 'second_commander_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Cuerpo.commander_name'
        db.add_column('censo_cuerpo', 'commander_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Cuerpo.superintendent_name'
        db.add_column('censo_cuerpo', 'superintendent_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Cuerpo.third_commander_name'
        db.add_column('censo_cuerpo', 'third_commander_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Cuerpo.observations'
        db.add_column('censo_cuerpo', 'observations', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Cuerpo.treasury_name'
        db.add_column('censo_cuerpo', 'treasury_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Cuerpo.vice_superintendent_name'
        db.add_column('censo_cuerpo', 'vice_superintendent_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Cuerpo.intendent_name'
        db.add_column('censo_cuerpo', 'intendent_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Cuerpo.secretary_name'
        db.add_column('censo_cuerpo', 'secretary_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Cuerpo.forth_commander_name'
        db.add_column('censo_cuerpo', 'forth_commander_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Cuerpo.second_commander_name'
        db.delete_column('censo_cuerpo', 'second_commander_name')

        # Deleting field 'Cuerpo.commander_name'
        db.delete_column('censo_cuerpo', 'commander_name')

        # Deleting field 'Cuerpo.superintendent_name'
        db.delete_column('censo_cuerpo', 'superintendent_name')

        # Deleting field 'Cuerpo.third_commander_name'
        db.delete_column('censo_cuerpo', 'third_commander_name')

        # Deleting field 'Cuerpo.observations'
        db.delete_column('censo_cuerpo', 'observations')

        # Deleting field 'Cuerpo.treasury_name'
        db.delete_column('censo_cuerpo', 'treasury_name')

        # Deleting field 'Cuerpo.vice_superintendent_name'
        db.delete_column('censo_cuerpo', 'vice_superintendent_name')

        # Deleting field 'Cuerpo.intendent_name'
        db.delete_column('censo_cuerpo', 'intendent_name')

        # Deleting field 'Cuerpo.secretary_name'
        db.delete_column('censo_cuerpo', 'secretary_name')

        # Deleting field 'Cuerpo.forth_commander_name'
        db.delete_column('censo_cuerpo', 'forth_commander_name')
