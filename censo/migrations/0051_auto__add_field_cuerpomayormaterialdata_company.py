...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoMayorMaterialData.company'
        db.add_column('censo_cuerpomayormaterialdata', 'company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Company'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CuerpoMayorMaterialData.company'
        db.delete_column('censo_cuerpomayormaterialdata', 'company_id')
