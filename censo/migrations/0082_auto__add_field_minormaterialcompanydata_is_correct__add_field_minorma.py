...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MinorMaterialCompanyData.is_correct'
        db.add_column('censo_minormaterialcompanydata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.is_complete'
        db.add_column('censo_minormaterialcompanydata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'InfrastructureCompanyData.is_correct'
        db.add_column('censo_infrastructurecompanydata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'InfrastructureCompanyData.is_complete'
        db.add_column('censo_infrastructurecompanydata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'VolunteerData.is_correct'
        db.add_column('censo_volunteerdata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'VolunteerData.is_complete'
        db.add_column('censo_volunteerdata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'MinorMaterialCompanyData.is_correct'
        db.delete_column('censo_minormaterialcompanydata', 'is_correct')

        # Deleting field 'MinorMaterialCompanyData.is_complete'
        db.delete_column('censo_minormaterialcompanydata', 'is_complete')

        # Deleting field 'InfrastructureCompanyData.is_correct'
        db.delete_column('censo_infrastructurecompanydata', 'is_correct')

        # Deleting field 'InfrastructureCompanyData.is_complete'
        db.delete_column('censo_infrastructurecompanydata', 'is_complete')

        # Deleting field 'VolunteerData.is_correct'
        db.delete_column('censo_volunteerdata', 'is_correct')

        # Deleting field 'VolunteerData.is_complete'
        db.delete_column('censo_volunteerdata', 'is_complete')
