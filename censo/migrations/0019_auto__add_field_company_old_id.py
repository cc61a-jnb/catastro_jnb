...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.old_id'
        db.add_column('censo_company', 'old_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Company.old_id'
        db.delete_column('censo_company', 'old_id')
