...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.old_id'
        db.add_column('censo_userprofile', 'old_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Role.old_id'
        db.add_column('censo_role', 'old_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.old_id'
        db.delete_column('censo_userprofile', 'old_id')

        # Deleting field 'Role.old_id'
        db.delete_column('censo_role', 'old_id')
