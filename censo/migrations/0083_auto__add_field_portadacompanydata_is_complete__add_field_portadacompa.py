...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PortadaCompanyData.is_complete'
        db.add_column('censo_portadacompanydata', 'is_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCompanyData.is_correct'
        db.add_column('censo_portadacompanydata', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'PortadaCompanyData.is_complete'
        db.delete_column('censo_portadacompanydata', 'is_complete')

        # Deleting field 'PortadaCompanyData.is_correct'
        db.delete_column('censo_portadacompanydata', 'is_correct')
