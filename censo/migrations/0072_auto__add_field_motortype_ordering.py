...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MotorType.ordering'
        db.add_column('censo_motortype', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'MotorType.ordering'
        db.delete_column('censo_motortype', 'ordering')
