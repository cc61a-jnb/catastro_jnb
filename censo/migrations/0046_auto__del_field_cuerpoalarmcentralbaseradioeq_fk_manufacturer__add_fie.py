...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('censo_cuerpoalarmcentralbaseradioeq', 'manufacturer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PortableBrand'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('censo_cuerpoalarmcentralbaseradioeq', 'manufacturer_id')
