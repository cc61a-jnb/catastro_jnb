...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CuerpoInfrastructureOtherOffices'
        db.create_table('censo_cuerpoinfrastructureotheroffices', (
        ...
        db.send_create_signal('censo', ['CuerpoInfrastructureOtherOffices'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CuerpoInfrastructureOtherOffices'
        db.delete_table('censo_cuerpoinfrastructureotheroffices')
