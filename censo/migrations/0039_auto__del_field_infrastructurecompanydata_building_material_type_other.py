...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InfrastructureCompanyData.building_material_type_other'
        db.delete_column('censo_infrastructurecompanydata', 'building_material_type_other')

        # Deleting field 'InfrastructureCompanyData.terrain_session_room_m2'
        db.delete_column('censo_infrastructurecompanydata', 'terrain_session_room_m2')

        # Deleting field 'InfrastructureCompanyData.property_title_type_other'
        db.delete_column('censo_infrastructurecompanydata', 'property_title_type_other')

        # Adding field 'InfrastructureCompanyData.bool_terrain_session_room_m2'
        db.add_column('censo_infrastructurecompanydata', 'bool_terrain_session_room_m2', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'InfrastructureCompanyData.building_material_type_other'
        db.add_column('censo_infrastructurecompanydata', 'building_material_type_other', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'InfrastructureCompanyData.terrain_session_room_m2'
        db.add_column('censo_infrastructurecompanydata', 'terrain_session_room_m2', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'InfrastructureCompanyData.property_title_type_other'
        db.add_column('censo_infrastructurecompanydata', 'property_title_type_other', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'InfrastructureCompanyData.bool_terrain_session_room_m2'
        db.delete_column('censo_infrastructurecompanydata', 'bool_terrain_session_room_m2')
    ...
    models = {
        ...
        'censo.infrastructurecompanydata': {
            ...
            'bool_terrain_session_room_m2': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
