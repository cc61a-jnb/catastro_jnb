...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CompanyAntenas.antenas_quantity'
        db.delete_column('censo_companyantenas', 'antenas_quantity')

        # Adding field 'CompanyAntenas.antennas_quantity'
        db.add_column('censo_companyantenas', 'antennas_quantity', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CompanyAntenas.antenas_quantity'
        db.add_column('censo_companyantenas', 'antenas_quantity', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True), keep_default=False)

        # Deleting field 'CompanyAntenas.antennas_quantity'
        db.delete_column('censo_companyantenas', 'antennas_quantity')
