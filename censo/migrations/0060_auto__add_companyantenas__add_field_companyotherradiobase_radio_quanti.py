...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompanyAntenas'
        db.create_table('censo_companyantenas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Company'])),
            ('antenas_quantity', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('antennas_manufacturer', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('antennas_model', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('antennas_power', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('censo', ['CompanyAntenas'])

        # Adding field 'CompanyOtherRadioBase.radio_quantity'
        db.add_column('censo_companyotherradiobase', 'radio_quantity', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True), keep_default=False)

        # Adding field 'CompanyOtherRadioBase.radio_power'
        db.add_column('censo_companyotherradiobase', 'radio_power', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True), keep_default=False)

        # Deleting field 'CompanyOtherRadioPortable.radio_portable_power'
        db.delete_column('censo_companyotherradioportable', 'radio_portable_power')

        # Adding field 'CompanyOtherRadioPortable.radio_portable_quantity'
        db.add_column('censo_companyotherradioportable', 'radio_portable_quantity', self.gf('django.db.models.fields.IntegerField')(max_length=3, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'CompanyAntenas'
        db.delete_table('censo_companyantenas')

        # Deleting field 'CompanyOtherRadioBase.radio_quantity'
        db.delete_column('censo_companyotherradiobase', 'radio_quantity')

        # Deleting field 'CompanyOtherRadioBase.radio_power'
        db.delete_column('censo_companyotherradiobase', 'radio_power')

        # Adding field 'CompanyOtherRadioPortable.radio_portable_power'
        db.add_column('censo_companyotherradioportable', 'radio_portable_power', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True), keep_default=False)

        # Deleting field 'CompanyOtherRadioPortable.radio_portable_quantity'
        db.delete_column('censo_companyotherradioportable', 'radio_portable_quantity')
    ...
    models = {
        ...
        'censo.companyantenas': {
            ...
            'antenas_quantity': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
        ...
        'censo.cuerpomayormaterialdata': {
            ...
            'vehicle_checkup': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'vehicle_registration': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
