...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VolunteerData.internet_provider'
        db.delete_column('censo_volunteerdata', 'internet_provider')

        # Adding field 'VolunteerData.fk_internet_provider'
        db.add_column('censo_volunteerdata', 'fk_internet_provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.InternetProvider'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'VolunteerData.internet_provider'
        db.add_column('censo_volunteerdata', 'internet_provider', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Deleting field 'VolunteerData.fk_internet_provider'
        db.delete_column('censo_volunteerdata', 'fk_internet_provider_id')
