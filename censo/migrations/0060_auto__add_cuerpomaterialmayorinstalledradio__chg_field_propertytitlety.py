...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CuerpoMaterialMayorInstalledRadio'
        db.create_table('censo_cuerpomaterialmayorinstalledradio', (
            ('installed_radio_potency', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('installed_radio_brand', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('installed_radio_model', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('installed_radio_quantity', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('material_mayor_data', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.CuerpoMayorMaterialData'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('censo', ['CuerpoMaterialMayorInstalledRadio'])

        # Changing field 'PropertyTitleType.requires_end_year'
        db.alter_column('censo_propertytitletype', 'requires_end_year', self.gf('django.db.models.fields.BooleanField')(blank=True))
        ...
        # Changing field 'CuerpoMayorMaterialData.vehicle_checkup'
        db.alter_column('censo_cuerpomayormaterialdata', 'vehicle_checkup', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CuerpoMayorMaterialData.vehicle_registration'
        db.alter_column('censo_cuerpomayormaterialdata', 'vehicle_registration', self.gf('django.db.models.fields.BooleanField')(blank=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CuerpoMaterialMayorInstalledRadio'
        db.delete_table('censo_cuerpomaterialmayorinstalledradio')

        # Changing field 'PropertyTitleType.requires_end_year'
        db.alter_column('censo_propertytitletype', 'requires_end_year', self.gf('django.db.models.fields.BooleanField')())
        ...
        # Changing field 'CuerpoMayorMaterialData.vehicle_checkup'
        db.alter_column('censo_cuerpomayormaterialdata', 'vehicle_checkup', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CuerpoMayorMaterialData.vehicle_registration'
        db.alter_column('censo_cuerpomayormaterialdata', 'vehicle_registration', self.gf('django.db.models.fields.BooleanField')())
