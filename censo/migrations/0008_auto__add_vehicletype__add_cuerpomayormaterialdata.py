...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('censo_vehicletype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('censo', ['VehicleType'])

        # Adding model 'CuerpoMayorMaterialData'
        db.create_table('censo_cuerpomayormaterialdata', (
            ('cuerpo', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['censo.Cuerpo'], unique=True, blank=True)),
            ('fk_vehicle_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.VehicleType'], null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('censo', ['CuerpoMayorMaterialData'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'VehicleType'
        db.delete_table('censo_vehicletype')

        # Deleting model 'CuerpoMayorMaterialData'
        db.delete_table('censo_cuerpomayormaterialdata')
