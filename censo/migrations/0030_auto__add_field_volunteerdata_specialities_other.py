...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VolunteerData.specialities_other'
        db.add_column('censo_volunteerdata', 'specialities_other', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VolunteerData.specialities_other'
        db.delete_column('censo_volunteerdata', 'specialities_other')
