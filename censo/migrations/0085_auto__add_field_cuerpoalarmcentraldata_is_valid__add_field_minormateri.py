...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoAlarmCentralData.is_valid'
        db.add_column('censo_cuerpoalarmcentraldata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.is_valid'
        db.add_column('censo_minormaterialcompanydata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.is_valid'
        db.add_column('censo_portadacuerpodata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoGeneralData.is_valid'
        db.add_column('censo_cuerpogeneraldata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoInfrastructureData.is_valid'
        db.add_column('censo_cuerpoinfrastructuredata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoServiceActsData.is_valid'
        db.add_column('censo_cuerposerviceactsdata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'InfrastructureCompanyData.is_valid'
        db.add_column('censo_infrastructurecompanydata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoANBData.is_valid'
        db.add_column('censo_cuerpoanbdata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCompanyData.is_valid'
        db.add_column('censo_portadacompanydata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.is_valid'
        db.add_column('censo_cuerpomayormaterialdata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'VolunteerData.is_valid'
        db.add_column('censo_volunteerdata', 'is_valid', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CuerpoAlarmCentralData.is_valid'
        db.delete_column('censo_cuerpoalarmcentraldata', 'is_valid')

        # Deleting field 'MinorMaterialCompanyData.is_valid'
        db.delete_column('censo_minormaterialcompanydata', 'is_valid')

        # Deleting field 'PortadaCuerpoData.is_valid'
        db.delete_column('censo_portadacuerpodata', 'is_valid')

        # Deleting field 'CuerpoGeneralData.is_valid'
        db.delete_column('censo_cuerpogeneraldata', 'is_valid')

        # Deleting field 'CuerpoInfrastructureData.is_valid'
        db.delete_column('censo_cuerpoinfrastructuredata', 'is_valid')

        # Deleting field 'CuerpoServiceActsData.is_valid'
        db.delete_column('censo_cuerposerviceactsdata', 'is_valid')

        # Deleting field 'InfrastructureCompanyData.is_valid'
        db.delete_column('censo_infrastructurecompanydata', 'is_valid')

        # Deleting field 'CuerpoANBData.is_valid'
        db.delete_column('censo_cuerpoanbdata', 'is_valid')

        # Deleting field 'PortadaCompanyData.is_valid'
        db.delete_column('censo_portadacompanydata', 'is_valid')

        # Deleting field 'CuerpoMayorMaterialData.is_valid'
        db.delete_column('censo_cuerpomayormaterialdata', 'is_valid')

        # Deleting field 'VolunteerData.is_valid'
        db.delete_column('censo_volunteerdata', 'is_valid')
