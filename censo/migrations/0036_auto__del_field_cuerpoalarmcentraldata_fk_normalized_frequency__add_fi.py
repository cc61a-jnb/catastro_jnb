...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CuerpoAlarmCentralData.fk_normalized_frequency'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fk_normalized_frequency_id')

        # Adding field 'CuerpoAlarmCentralData.normalized_frequency'
        db.add_column('censo_cuerpoalarmcentraldata', 'normalized_frequency', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'CuerpoAlarmCentralData.fk_bandwidth'
        db.alter_column('censo_cuerpoalarmcentraldata', 'fk_bandwidth_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['censo.BandWidth']))

        # Changing field 'CuerpoAlarmCentralData.frequency_one'
        db.alter_column('censo_cuerpoalarmcentraldata', 'frequency_one', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=6, decimal_places=3))


    def backwards(self, orm):
        
        # Adding field 'CuerpoAlarmCentralData.fk_normalized_frequency'
        db.add_column('censo_cuerpoalarmcentraldata', 'fk_normalized_frequency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.NormalizedFrequency'], null=True, blank=True), keep_default=False)

        # Deleting field 'CuerpoAlarmCentralData.normalized_frequency'
        db.delete_column('censo_cuerpoalarmcentraldata', 'normalized_frequency')
        ...
        # Changing field 'CuerpoAlarmCentralData.frequency_one'
        db.alter_column('censo_cuerpoalarmcentraldata', 'frequency_one', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=3))
    ...
    models = {
        ...
        'censo.cuerpoalarmcentraldata': {
            ...
            'fk_bandwidth': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.BandWidth']"}),
            ...
            'frequency_one': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '3'}),
            ...
            'normalized_frequency': ('django.db.models.fields.IntegerField', [], {}),
