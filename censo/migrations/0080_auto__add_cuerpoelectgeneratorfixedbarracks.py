...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CuerpoElectGeneratorFixedBarracks'
        db.create_table('censo_cuerpoelectgeneratorfixedbarracks', (
            ...
            ('infrastructure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.CuerpoInfrastructureData'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('censo', ['CuerpoElectGeneratorFixedBarracks'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CuerpoElectGeneratorFixedBarracks'
        db.delete_table('censo_cuerpoelectgeneratorfixedbarracks')
