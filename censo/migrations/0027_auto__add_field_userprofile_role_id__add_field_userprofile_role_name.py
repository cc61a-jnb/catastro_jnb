...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.role_id'
        db.add_column('censo_userprofile', 'role_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'UserProfile.role_name'
        db.add_column('censo_userprofile', 'role_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.role_id'
        db.delete_column('censo_userprofile', 'role_id')

        # Deleting field 'UserProfile.role_name'
        db.delete_column('censo_userprofile', 'role_name')
