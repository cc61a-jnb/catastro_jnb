...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoMayorMaterialData.cuerpo_vehicle_own'
        db.add_column('censo_cuerpomayormaterialdata', 'cuerpo_vehicle_own', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CuerpoMayorMaterialData.cuerpo_vehicle_own'
        db.delete_column('censo_cuerpomayormaterialdata', 'cuerpo_vehicle_own')
