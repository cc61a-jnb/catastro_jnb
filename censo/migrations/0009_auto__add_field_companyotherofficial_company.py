...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CompanyOtherOfficial.company'
        db.add_column('censo_companyotherofficial', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['censo.Company']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CompanyOtherOfficial.company'
        db.delete_column('censo_companyotherofficial', 'company_id')
