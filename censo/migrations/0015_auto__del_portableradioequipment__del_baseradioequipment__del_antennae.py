...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'PortableRadioEquipment'
        db.delete_table('censo_portableradioequipment')

        # Deleting model 'BaseRadioEquipment'
        db.delete_table('censo_baseradioequipment')

        # Deleting model 'AntennaEquipment'
        db.delete_table('censo_antennaequipment')

        # Adding field 'MinorMaterialCompanyData.base_radio_equipment_manufacturer'
        db.add_column('censo_minormaterialcompanydata', 'base_radio_equipment_manufacturer', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.portable_radio_equipment_model'
        db.add_column('censo_minormaterialcompanydata', 'portable_radio_equipment_model', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.antenna_equipment_model'
        db.add_column('censo_minormaterialcompanydata', 'antenna_equipment_model', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.portable_radio_equipment_manufacturer'
        db.add_column('censo_minormaterialcompanydata', 'portable_radio_equipment_manufacturer', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.base_radio_equipment_quantity'
        db.add_column('censo_minormaterialcompanydata', 'base_radio_equipment_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.antenna_equipment_manufacturer'
        db.add_column('censo_minormaterialcompanydata', 'antenna_equipment_manufacturer', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.antenna_equipment_quantity'
        db.add_column('censo_minormaterialcompanydata', 'antenna_equipment_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.base_radio_equipment_model'
        db.add_column('censo_minormaterialcompanydata', 'base_radio_equipment_model', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.portable_radio_equipment_quantity'
        db.add_column('censo_minormaterialcompanydata', 'portable_radio_equipment_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.antenna_equipment_power'
        db.add_column('censo_minormaterialcompanydata', 'antenna_equipment_power', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.base_radio_equipment_power'
        db.add_column('censo_minormaterialcompanydata', 'base_radio_equipment_power', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding model 'PortableRadioEquipment'
        db.create_table('censo_portableradioequipment', (
            ('model', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('minor_material_company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.MinorMaterialCompanyData'], null=True, blank=True)),
        ...
        db.send_create_signal('censo', ['PortableRadioEquipment'])

        # Adding model 'BaseRadioEquipment'
        db.create_table('censo_baseradioequipment', (
        ...
        db.send_create_signal('censo', ['BaseRadioEquipment'])

        # Adding model 'AntennaEquipment'
        db.create_table('censo_antennaequipment', (
            ('power', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('model', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('minor_material_company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.MinorMaterialCompanyData'], null=True, blank=True)),
        ...
        db.send_create_signal('censo', ['AntennaEquipment'])

        # Deleting field 'MinorMaterialCompanyData.base_radio_equipment_manufacturer'
        db.delete_column('censo_minormaterialcompanydata', 'base_radio_equipment_manufacturer')

        # Deleting field 'MinorMaterialCompanyData.portable_radio_equipment_model'
        db.delete_column('censo_minormaterialcompanydata', 'portable_radio_equipment_model')

        # Deleting field 'MinorMaterialCompanyData.antenna_equipment_model'
        db.delete_column('censo_minormaterialcompanydata', 'antenna_equipment_model')

        # Deleting field 'MinorMaterialCompanyData.portable_radio_equipment_manufacturer'
        db.delete_column('censo_minormaterialcompanydata', 'portable_radio_equipment_manufacturer')

        # Deleting field 'MinorMaterialCompanyData.base_radio_equipment_quantity'
        db.delete_column('censo_minormaterialcompanydata', 'base_radio_equipment_quantity')

        # Deleting field 'MinorMaterialCompanyData.antenna_equipment_manufacturer'
        db.delete_column('censo_minormaterialcompanydata', 'antenna_equipment_manufacturer')

        # Deleting field 'MinorMaterialCompanyData.antenna_equipment_quantity'
        db.delete_column('censo_minormaterialcompanydata', 'antenna_equipment_quantity')

        # Deleting field 'MinorMaterialCompanyData.base_radio_equipment_model'
        db.delete_column('censo_minormaterialcompanydata', 'base_radio_equipment_model')

        # Deleting field 'MinorMaterialCompanyData.portable_radio_equipment_quantity'
        db.delete_column('censo_minormaterialcompanydata', 'portable_radio_equipment_quantity')

        # Deleting field 'MinorMaterialCompanyData.antenna_equipment_power'
        db.delete_column('censo_minormaterialcompanydata', 'antenna_equipment_power')

        # Deleting field 'MinorMaterialCompanyData.base_radio_equipment_power'
        db.delete_column('censo_minormaterialcompanydata', 'base_radio_equipment_power')
