...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('censo_userprofile', 'current_role', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['censo.Role']), keep_default=False)

        # Adding field 'UserProfile.gender'
        db.add_column('censo_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(default='M', max_length=1), keep_default=False)
