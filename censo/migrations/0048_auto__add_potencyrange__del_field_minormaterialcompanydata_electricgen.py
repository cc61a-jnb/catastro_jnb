...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PotencyRange'
        db.create_table('censo_potencyrange', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['PotencyRange'])

        # Deleting field 'MinorMaterialCompanyData.electricgenerator_fixed_in_car_potency'
        db.delete_column('censo_minormaterialcompanydata', 'electricgenerator_fixed_in_car_potency')

        # Adding field 'MinorMaterialCompanyData.fk_electricgenerator_fixed_in_car_potency'
        db.add_column('censo_minormaterialcompanydata', 'fk_electricgenerator_fixed_in_car_potency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PotencyRange'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'PotencyRange'
        db.delete_table('censo_potencyrange')

        # Adding field 'MinorMaterialCompanyData.electricgenerator_fixed_in_car_potency'
        db.add_column('censo_minormaterialcompanydata', 'electricgenerator_fixed_in_car_potency', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'censo.minormaterialcompanydata': {
            ...
            'fk_electricgenerator_fixed_in_car_potency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.PotencyRange']", 'null': 'True', 'blank': 'True'}),
