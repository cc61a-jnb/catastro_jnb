...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InfrastructureCompanyData.fk_property_title_type'
        db.alter_column('censo_infrastructurecompanydata', 'fk_property_title_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PropertyTitleType']))
    
    
    def backwards(self, orm):
        
        # Changing field 'InfrastructureCompanyData.fk_property_title_type'
        db.alter_column('censo_infrastructurecompanydata', 'fk_property_title_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PropertyTitleType'], null=True, blank=True))
    ...
    models = {
        ...
        'censo.infrastructurecompanydata': {
            ...
            'fk_property_title_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.PropertyTitleType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
