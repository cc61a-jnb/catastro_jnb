...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Role', fields ['old_id']
        db.create_unique('censo_role', ['old_id'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'Role', fields ['old_id']
        db.delete_unique('censo_role', ['old_id'])
