...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('censo_infrastructurecompanydata', 'fk_property_title_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PropertyTitleType'], null=True))
