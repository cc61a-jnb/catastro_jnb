...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('censo_userprofile', 'occupation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Occupation'], null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.occupation'
        db.alter_column('censo_userprofile', 'occupation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Occupation']))
