...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfrastructureCompanyData.picture_front_view'
        db.add_column('censo_infrastructurecompanydata', 'picture_front_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)

        # Adding field 'InfrastructureCompanyData.picture_machine_room_view'
        db.add_column('censo_infrastructurecompanydata', 'picture_machine_room_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)

        # Adding field 'InfrastructureCompanyData.picture_office_view'
        db.add_column('censo_infrastructurecompanydata', 'picture_office_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)

        # Adding field 'InfrastructureCompanyData.picture_internal_distribution_view'
        db.add_column('censo_infrastructurecompanydata', 'picture_internal_distribution_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)

        # Adding field 'InfrastructureCompanyData.picture_back_view'
        db.add_column('censo_infrastructurecompanydata', 'picture_back_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'InfrastructureCompanyData.picture_front_view'
        db.delete_column('censo_infrastructurecompanydata', 'picture_front_view')

        # Deleting field 'InfrastructureCompanyData.picture_machine_room_view'
        db.delete_column('censo_infrastructurecompanydata', 'picture_machine_room_view')

        # Deleting field 'InfrastructureCompanyData.picture_office_view'
        db.delete_column('censo_infrastructurecompanydata', 'picture_office_view')

        # Deleting field 'InfrastructureCompanyData.picture_internal_distribution_view'
        db.delete_column('censo_infrastructurecompanydata', 'picture_internal_distribution_view')

        # Deleting field 'InfrastructureCompanyData.picture_back_view'
        db.delete_column('censo_infrastructurecompanydata', 'picture_back_view')
