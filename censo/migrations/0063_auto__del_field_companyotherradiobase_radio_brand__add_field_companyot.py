...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CompanyOtherRadioBase.radio_brand'
        db.delete_column('censo_companyotherradiobase', 'radio_brand')

        # Adding field 'CompanyOtherRadioBase.fk_radio_brand'
        db.add_column('censo_companyotherradiobase', 'fk_radio_brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PortableBrand'], null=True, blank=True), keep_default=False)

        # Deleting field 'CompanyOtherRadioPortable.radio_portable_brand'
        db.delete_column('censo_companyotherradioportable', 'radio_portable_brand')

        # Adding field 'CompanyOtherRadioPortable.fk_radio_portable_brand'
        db.add_column('censo_companyotherradioportable', 'fk_radio_portable_brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PortableBrand'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'CompanyOtherRadioBase.radio_brand'
        db.add_column('censo_companyotherradiobase', 'radio_brand', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'CompanyOtherRadioBase.fk_radio_brand'
        db.delete_column('censo_companyotherradiobase', 'fk_radio_brand_id')

        # Adding field 'CompanyOtherRadioPortable.radio_portable_brand'
        db.add_column('censo_companyotherradioportable', 'radio_portable_brand', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'CompanyOtherRadioPortable.fk_radio_portable_brand'
        db.delete_column('censo_companyotherradioportable', 'fk_radio_portable_brand_id')
