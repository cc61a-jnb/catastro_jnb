...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CuerpoMayorMaterialData.picture_front_view'
        db.alter_column('censo_cuerpomayormaterialdata', 'picture_front_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

        # Changing field 'CuerpoMayorMaterialData.picture_back_view'
        db.alter_column('censo_cuerpomayormaterialdata', 'picture_back_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

        # Changing field 'CuerpoMayorMaterialData.picture_side_view'
        db.alter_column('censo_cuerpomayormaterialdata', 'picture_side_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'CuerpoMayorMaterialData.picture_front_view'
        db.alter_column('censo_cuerpomayormaterialdata', 'picture_front_view', self.gf('sorl.thumbnail.fields.ImageField')(default=None, max_length=100))

        # Changing field 'CuerpoMayorMaterialData.picture_back_view'
        db.alter_column('censo_cuerpomayormaterialdata', 'picture_back_view', self.gf('sorl.thumbnail.fields.ImageField')(default=None, max_length=100))

        # Changing field 'CuerpoMayorMaterialData.picture_side_view'
        db.alter_column('censo_cuerpomayormaterialdata', 'picture_side_view', self.gf('sorl.thumbnail.fields.ImageField')(default=None, max_length=100))
