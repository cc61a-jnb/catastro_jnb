...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CuerpoMaterialMayorGeneratorFixed'
        db.create_table('censo_cuerpomaterialmayorgeneratorfixed', (
            ('material_mayor_data', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.CuerpoMayorMaterialData'])),
            ('potency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PotencyRange'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('censo', ['CuerpoMaterialMayorGeneratorFixed'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CuerpoMaterialMayorGeneratorFixed'
        db.delete_table('censo_cuerpomaterialmayorgeneratorfixed')
