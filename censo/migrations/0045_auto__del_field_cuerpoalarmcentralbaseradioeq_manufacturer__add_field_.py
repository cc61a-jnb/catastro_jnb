...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CuerpoAlarmCentralBaseRadioEq.manufacturer'
        db.delete_column('censo_cuerpoalarmcentralbaseradioeq', 'manufacturer')

        # Adding field 'CuerpoAlarmCentralBaseRadioEq.fk_manufacturer'
        db.add_column('censo_cuerpoalarmcentralbaseradioeq', 'fk_manufacturer', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['censo.PortableBrand']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'CuerpoAlarmCentralBaseRadioEq.manufacturer'
        db.add_column('censo_cuerpoalarmcentralbaseradioeq', 'manufacturer', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'CuerpoAlarmCentralBaseRadioEq.fk_manufacturer'
        db.delete_column('censo_cuerpoalarmcentralbaseradioeq', 'fk_manufacturer_id')
    ...
    models = {
        ...
        'censo.cuerpoalarmcentralbaseradioeq': {
            ...
            'fk_manufacturer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.PortableBrand']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
