...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoInfrastructureData.picture_front_view'
        db.add_column('censo_cuerpoinfrastructuredata', 'picture_front_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)

        # Adding field 'CuerpoInfrastructureData.picture_internal_distribution_view'
        db.add_column('censo_cuerpoinfrastructuredata', 'picture_internal_distribution_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)

        # Adding field 'CuerpoInfrastructureData.picture_general_view'
        db.add_column('censo_cuerpoinfrastructuredata', 'picture_general_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)

        # Adding field 'CuerpoInfrastructureData.picture_office_view'
        db.add_column('censo_cuerpoinfrastructuredata', 'picture_office_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)

        # Adding field 'CuerpoInfrastructureData.picture_back_view'
        db.add_column('censo_cuerpoinfrastructuredata', 'picture_back_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)

        # Adding field 'CuerpoInfrastructureData.picture_machine_room_view'
        db.add_column('censo_cuerpoinfrastructuredata', 'picture_machine_room_view', self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CuerpoInfrastructureData.picture_front_view'
        db.delete_column('censo_cuerpoinfrastructuredata', 'picture_front_view')

        # Deleting field 'CuerpoInfrastructureData.picture_internal_distribution_view'
        db.delete_column('censo_cuerpoinfrastructuredata', 'picture_internal_distribution_view')

        # Deleting field 'CuerpoInfrastructureData.picture_general_view'
        db.delete_column('censo_cuerpoinfrastructuredata', 'picture_general_view')

        # Deleting field 'CuerpoInfrastructureData.picture_office_view'
        db.delete_column('censo_cuerpoinfrastructuredata', 'picture_office_view')

        # Deleting field 'CuerpoInfrastructureData.picture_back_view'
        db.delete_column('censo_cuerpoinfrastructuredata', 'picture_back_view')

        # Deleting field 'CuerpoInfrastructureData.picture_machine_room_view'
        db.delete_column('censo_cuerpoinfrastructuredata', 'picture_machine_room_view')
