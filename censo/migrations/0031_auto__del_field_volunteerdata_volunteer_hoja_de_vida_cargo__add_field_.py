...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VolunteerData.volunteer_hoja_de_vida_cargo'
        db.delete_column('censo_volunteerdata', 'volunteer_hoja_de_vida_cargo')

        # Adding field 'VolunteerData.fk_volunteer_hoja_de_vida_cargo'
        db.add_column('censo_volunteerdata', 'fk_volunteer_hoja_de_vida_cargo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Role'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'VolunteerData.volunteer_hoja_de_vida_cargo'
        db.add_column('censo_volunteerdata', 'volunteer_hoja_de_vida_cargo', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'VolunteerData.fk_volunteer_hoja_de_vida_cargo'
        db.delete_column('censo_volunteerdata', 'fk_volunteer_hoja_de_vida_cargo_id')
