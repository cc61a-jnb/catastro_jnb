...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoMayorMaterialData.denomination'
        db.add_column('censo_cuerpomayormaterialdata', 'denomination', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CuerpoMayorMaterialData.denomination'
        db.delete_column('censo_cuerpomayormaterialdata', 'denomination')
