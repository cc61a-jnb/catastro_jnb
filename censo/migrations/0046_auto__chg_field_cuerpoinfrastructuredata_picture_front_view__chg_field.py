...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CuerpoInfrastructureData.picture_front_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_front_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'CuerpoInfrastructureData.picture_internal_distribution_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_internal_distribution_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'CuerpoInfrastructureData.fk_property_title_type'
        db.alter_column('censo_cuerpoinfrastructuredata', 'fk_property_title_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PropertyTitleType'], null=True, blank=True))

        # Changing field 'CuerpoInfrastructureData.picture_general_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_general_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'CuerpoInfrastructureData.picture_office_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_office_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'CuerpoInfrastructureData.picture_back_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_back_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))

        # Changing field 'CuerpoInfrastructureData.picture_machine_room_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_machine_room_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'CuerpoInfrastructureData.picture_front_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_front_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'CuerpoInfrastructureData.picture_internal_distribution_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_internal_distribution_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'CuerpoInfrastructureData.fk_property_title_type'
        db.alter_column('censo_cuerpoinfrastructuredata', 'fk_property_title_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PropertyTitleType'], null=True))

        # Changing field 'CuerpoInfrastructureData.picture_general_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_general_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'CuerpoInfrastructureData.picture_office_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_office_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'CuerpoInfrastructureData.picture_back_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_back_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'CuerpoInfrastructureData.picture_machine_room_view'
        db.alter_column('censo_cuerpoinfrastructuredata', 'picture_machine_room_view', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
