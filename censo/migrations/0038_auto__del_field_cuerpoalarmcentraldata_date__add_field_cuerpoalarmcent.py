...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CuerpoAlarmCentralData.date'
        db.delete_column('censo_cuerpoalarmcentraldata', 'date')

        # Adding field 'CuerpoAlarmCentralData.decree_date'
        db.add_column('censo_cuerpoalarmcentraldata', 'decree_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CuerpoAlarmCentralData.date'
        db.add_column('censo_cuerpoalarmcentraldata', 'date', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'CuerpoAlarmCentralData.decree_date'
        db.delete_column('censo_cuerpoalarmcentraldata', 'decree_date')
