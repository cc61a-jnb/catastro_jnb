...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('censo_cuerpo', 'commune_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['censo.Commune']))

        # Changing field 'Cuerpo.cuer_npers_juri'
        db.alter_column('censo_cuerpo', 'cuer_npers_juri', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Cuerpo.cuer_npers_juri'
        db.alter_column('censo_cuerpo', 'cuer_npers_juri', self.gf('django.db.models.fields.IntegerField')())
