...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MinorMaterialCompanyData'
        db.create_table('censo_minormaterialcompanydata', (
            ('cascade_bycar_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('oxygen_equipment_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('python_70tube_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('chainsaw_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('electricgenerator_fixed_in_barracks_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('airmattresses_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('containers_syntheticconcentrate_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('twins_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('firesfans_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('helmets_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('jackets_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('python_50adjustable_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('generators_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('defibrillator_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('scott_after_2004_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fireman_shoes_volunteer_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('python_70adjustable_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('electricgenerator_fixed_in_car_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cascade_cylinder_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('tripok_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('motorpump_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('electricgenerator_portable_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('racal_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('pants_or_overalls_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('protective_clothing_coated_aluminized_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fireman_shoes_company_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('hosepipe_80mm_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cascade_fixed_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('foam_generating_equipment_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('electricgenerator_portable_potency', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('company', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['censo.Company'], unique=True, blank=True)),
            ('aircompressor_bycar_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('levelA_chemical_protection_suits_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('hazmat_seal_kits_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gloves_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('hosepipe_forest_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('scott_before_2004_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('observations', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('fensy_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('instruments_of_toxic_gas_analysis_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('python_50tube_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('electricgenerator_fixed_in_car_potency', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('hydraulic_equipment_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mSA_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('aircompressor_fixed_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('hosepipe_50mm_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('electricgenerator_fixed_in_barracks_potency', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('short_capes_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('instruments_for_detection_of_combustible_gases_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('levelB_chemical_protection_suits_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('containers_proteinconcentrate_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('hosepipe_38mm_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('censo', ['MinorMaterialCompanyData'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'MinorMaterialCompanyData'
        db.delete_table('censo_minormaterialcompanydata')
