...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PortadaCompanyData'
        db.create_table('censo_portadacompanydata', (
            ('tesorero_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('assistant_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('company', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['censo.Company'], unique=True)),
            ('lieutenant_3_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('captain_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('director_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('secretary_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('lieutenant_2_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('lieutenant_4_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('lieutenant_1_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('censo', ['PortadaCompanyData'])

        # Deleting field 'Company.alarm_central'
        db.delete_column('censo_company', 'alarm_central')

        # Deleting field 'Company.tesorero_name'
        db.delete_column('censo_company', 'tesorero_name')

        # Deleting field 'Company.lieutenant_3_name'
        db.delete_column('censo_company', 'lieutenant_3_name')

        # Deleting field 'Company.director_name'
        db.delete_column('censo_company', 'director_name')

        # Deleting field 'Company.assistant_name'
        db.delete_column('censo_company', 'assistant_name')
        ...
        # Deleting field 'Company.lieutenant_4_name'
        db.delete_column('censo_company', 'lieutenant_4_name')
        ...
        # Deleting field 'Company.lieutenant_1_name'
        db.delete_column('censo_company', 'lieutenant_1_name')

        # Deleting field 'Company.secretary_name'
        db.delete_column('censo_company', 'secretary_name')

        # Deleting field 'Company.lieutenant_2_name'
        db.delete_column('censo_company', 'lieutenant_2_name')

        # Deleting field 'Company.captain_name'
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PortadaCompanyData'
        db.delete_table('censo_portadacompanydata')
        ...
        # Adding field 'Company.tesorero_name'
        db.add_column('censo_company', 'tesorero_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Company.lieutenant_3_name'
        db.add_column('censo_company', 'lieutenant_3_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Company.director_name'
        db.add_column('censo_company', 'director_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Company.assistant_name'
        db.add_column('censo_company', 'assistant_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)
        ...
        # Adding field 'Company.lieutenant_4_name'
        db.add_column('censo_company', 'lieutenant_4_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)
        ...
        # Adding field 'Company.lieutenant_1_name'
        db.add_column('censo_company', 'lieutenant_1_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Company.secretary_name'
        db.add_column('censo_company', 'secretary_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Company.lieutenant_2_name'
        db.add_column('censo_company', 'lieutenant_2_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Company.captain_name'
        db.add_column('censo_company', 'captain_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Changing field 'Company.commune'
        db.alter_column('censo_company', 'commune_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['censo.Commune'], blank=True))

        # Changing field 'Company.foundation_date'
        db.alter_column('censo_company', 'foundation_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True))

        # Changing field 'UserProfile.company'
        db.alter_column('censo_userprofile', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Company'], null=True, blank=True))
