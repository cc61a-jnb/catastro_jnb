...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InfrastructureStatus'
        db.create_table('censo_infrastructurestatus', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['InfrastructureStatus'])

        # Adding field 'CuerpoInfrastructureData.fk_infrastructure_status'
        db.add_column('censo_cuerpoinfrastructuredata', 'fk_infrastructure_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.InfrastructureStatus'], null=True, blank=True), keep_default=False)

        # Adding field 'InfrastructureCompanyData.fk_infrastructure_status'
        db.add_column('censo_infrastructurecompanydata', 'fk_infrastructure_status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.InfrastructureStatus'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'InfrastructureStatus'
        db.delete_table('censo_infrastructurestatus')

        # Deleting field 'CuerpoInfrastructureData.fk_infrastructure_status'
        db.delete_column('censo_cuerpoinfrastructuredata', 'fk_infrastructure_status_id')

        # Deleting field 'InfrastructureCompanyData.fk_infrastructure_status'
        db.delete_column('censo_infrastructurecompanydata', 'fk_infrastructure_status_id')
    ...
    models = {
        ...
        'censo.cuerpoinfrastructuredata': {
            ...
            'cuerpo': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['censo.Cuerpo']", 'unique': 'True', 'blank': 'True'}),
            'fk_infrastructure_status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.InfrastructureStatus']", 'null': 'True', 'blank': 'True'}),
        ...
        'censo.infrastructurestatus': {
            'Meta': {'object_name': 'InfrastructureStatus'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
