...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoMayorMaterialData.legal_repertorio_escritura'
        db.add_column('censo_cuerpomayormaterialdata', 'legal_repertorio_escritura', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.approval_number'
        db.add_column('censo_cuerpomayormaterialdata', 'approval_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.folio'
        db.add_column('censo_cuerpomayormaterialdata', 'folio', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.approval_certificate'
        db.add_column('censo_cuerpomayormaterialdata', 'approval_certificate', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.legal_notary'
        db.add_column('censo_cuerpomayormaterialdata', 'legal_notary', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.legal_registered_date'
        db.add_column('censo_cuerpomayormaterialdata', 'legal_registered_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.legal_registered_name'
        db.add_column('censo_cuerpomayormaterialdata', 'legal_registered_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CuerpoMayorMaterialData.legal_repertorio_escritura'
        db.delete_column('censo_cuerpomayormaterialdata', 'legal_repertorio_escritura')

        # Deleting field 'CuerpoMayorMaterialData.approval_number'
        db.delete_column('censo_cuerpomayormaterialdata', 'approval_number')

        # Deleting field 'CuerpoMayorMaterialData.folio'
        db.delete_column('censo_cuerpomayormaterialdata', 'folio')

        # Deleting field 'CuerpoMayorMaterialData.approval_certificate'
        db.delete_column('censo_cuerpomayormaterialdata', 'approval_certificate')

        # Deleting field 'CuerpoMayorMaterialData.legal_notary'
        db.delete_column('censo_cuerpomayormaterialdata', 'legal_notary')

        # Deleting field 'CuerpoMayorMaterialData.legal_registered_date'
        db.delete_column('censo_cuerpomayormaterialdata', 'legal_registered_date')

        # Deleting field 'CuerpoMayorMaterialData.legal_registered_name'
        db.delete_column('censo_cuerpomayormaterialdata', 'legal_registered_name')
    ...
    models = {
        ...
        'censo.cuerpomayormaterialdata': {
            ...
            'approval_certificate': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'approval_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'folio': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'legal_notary': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'legal_registered_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'legal_registered_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'legal_repertorio_escritura': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
