...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoMayorMaterialData.vehicle_checkup'
        db.add_column('censo_cuerpomayormaterialdata', 'vehicle_checkup', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.vehicle_registration'
        db.add_column('censo_cuerpomayormaterialdata', 'vehicle_registration', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'CuerpoMayorMaterialData.fk_vehicle_registration'
        db.add_column('censo_cuerpomayormaterialdata', 'fk_vehicle_registration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.VehicleRegistrationStatus'], null=True, blank=True), keep_default=False)

        # Adding field 'CuerpoMayorMaterialData.fk_vehicle_checkup'
        db.add_column('censo_cuerpomayormaterialdata', 'fk_vehicle_checkup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.VehicleCheckupStatus'], null=True, blank=True), keep_default=False)

        # Deleting field 'CuerpoMayorMaterialData.vehicle_checkup'
        db.delete_column('censo_cuerpomayormaterialdata', 'vehicle_checkup')

        # Deleting field 'CuerpoMayorMaterialData.vehicle_registration'
        db.delete_column('censo_cuerpomayormaterialdata', 'vehicle_registration')
