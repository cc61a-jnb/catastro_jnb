...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.cuerpo'
        db.add_column('censo_company', 'cuerpo', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['censo.Cuerpo']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Company.cuerpo'
        db.delete_column('censo_company', 'cuerpo_id')
