...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InternetProvider.ordering'
        db.add_column('censo_internetprovider', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'InternetProvider.ordering'
        db.delete_column('censo_internetprovider', 'ordering')
