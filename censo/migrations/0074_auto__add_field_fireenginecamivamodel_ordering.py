...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FireEngineCamivaModel.ordering'
        db.add_column('censo_fireenginecamivamodel', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'FireEngineCamivaModel.ordering'
        db.delete_column('censo_fireenginecamivamodel', 'ordering')
