...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PortableBrand'
        db.create_table('censo_portablebrand', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['PortableBrand'])
        ...
        # Adding field 'CuerpoAlarmCentralData.fk_portable_manufacturer1'
        db.add_column('censo_cuerpoalarmcentraldata', 'fk_portable_manufacturer1', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PortableBrand'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PortableBrand'
        db.delete_table('censo_portablebrand')
        ...
        # Deleting field 'CuerpoAlarmCentralData.fk_portable_manufacturer1'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fk_portable_manufacturer1_id')
    ...
    models = {
        ...
        'censo.cuerpoalarmcentraldata': {
            ...
            'fk_portable_manufacturer1': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['censo.PortableBrand']", 'null': 'True', 'blank': 'True'}),
