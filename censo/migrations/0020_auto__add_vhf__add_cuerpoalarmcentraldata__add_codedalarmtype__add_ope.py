...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VHF'
        db.create_table('censo_vhf', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['VHF'])

        # Adding model 'CuerpoAlarmCentralData'
        db.create_table('censo_cuerpoalarmcentraldata', (
            ('fk_bandwidth', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.BandWidth'], null=True)),
            ('frequency_two', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fk_coded_alarm', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.CodedAlarmType'], null=True, blank=True)),
            ('telephone_alarm_central', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('call_recording', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('cell_equipment_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fk_origin_software', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.OriginSystem'], null=True)),
            ('afternoon_roleshift_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('decree', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('digital_maps', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('energizing_backup_power', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('call_log', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('type_backup_power', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('tone_generator_capacity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('operators_availableatalltimes_quantity', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('frequency_four', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('sectorization', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('telephoneexchange_electricalsupport', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('fax_alarm_central', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('adm_dispatch', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('frequency_three', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('tone_generator_mark', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('observations', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('telephonelines_enable_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fk_vhf', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.VHF'], null=True)),
            ('frequency_one', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('autonomy_backup_power', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('potency_backup_power', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('fk_os', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.OperatingSystem'], null=True)),
            ('cuerpo', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['censo.Cuerpo'], unique=True, blank=True)),
            ('origin_software_other', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('pc_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fk_coded_keys', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.CodedKeysType'], null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('alarm_classification', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('telephoneexchange_satellitesupport_mark', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('email_alarm_central', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('key_coding', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('adm_digital_maps', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('operations_manual', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('tomorrow_roleshift_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('national_emergency_frequency', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('telephoneexchange_satellitesupport', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('adress_alarm_central', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('telephonelines_output_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('night_roleshift_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('telephonelines_input_quantity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('fk_normalized_frequency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.NormalizedFrequency'], null=True)),
        ))
        db.send_create_signal('censo', ['CuerpoAlarmCentralData'])

        # Adding model 'CodedAlarmType'
        db.create_table('censo_codedalarmtype', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['CodedAlarmType'])

        # Adding model 'OperatingSystem'
        db.create_table('censo_operatingsystem', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['OperatingSystem'])

        # Adding model 'OriginSystem'
        db.create_table('censo_originsystem', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['OriginSystem'])

        # Adding model 'BandWidth'
        db.create_table('censo_bandwidth', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['BandWidth'])

        # Adding model 'CodedKeysType'
        db.create_table('censo_codedkeystype', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['CodedKeysType'])

        # Adding model 'NormalizedFrequency'
        db.create_table('censo_normalizedfrequency', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('censo', ['NormalizedFrequency'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'VHF'
        db.delete_table('censo_vhf')

        # Deleting model 'CuerpoAlarmCentralData'
        db.delete_table('censo_cuerpoalarmcentraldata')

        # Deleting model 'CodedAlarmType'
        db.delete_table('censo_codedalarmtype')

        # Deleting model 'OperatingSystem'
        db.delete_table('censo_operatingsystem')

        # Deleting model 'OriginSystem'
        db.delete_table('censo_originsystem')

        # Deleting model 'BandWidth'
        db.delete_table('censo_bandwidth')

        # Deleting model 'CodedKeysType'
        db.delete_table('censo_codedkeystype')

        # Deleting model 'NormalizedFrequency'
        db.delete_table('censo_normalizedfrequency')
