...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VehicleCarrosadoManufacturer.ordering'
        db.add_column('censo_vehiclecarrosadomanufacturer', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VehicleCarrosadoManufacturer.ordering'
        db.delete_column('censo_vehiclecarrosadomanufacturer', 'ordering')
