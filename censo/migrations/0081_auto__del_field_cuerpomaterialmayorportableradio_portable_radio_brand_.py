...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CuerpoMaterialMayorPortableRadio.portable_radio_brand'
        db.delete_column('censo_cuerpomaterialmayorportableradio', 'portable_radio_brand')

        # Adding field 'CuerpoMaterialMayorPortableRadio.fk_portable_radio_brand'
        db.add_column('censo_cuerpomaterialmayorportableradio', 'fk_portable_radio_brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PortableBrand'], null=True, blank=True), keep_default=False)

        # Deleting field 'CuerpoMaterialMayorInstalledRadio.installed_radio_brand'
        db.delete_column('censo_cuerpomaterialmayorinstalledradio', 'installed_radio_brand')

        # Adding field 'CuerpoMaterialMayorInstalledRadio.fk_installed_radio_brand'
        db.add_column('censo_cuerpomaterialmayorinstalledradio', 'fk_installed_radio_brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.PortableBrand'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'CuerpoMaterialMayorPortableRadio.portable_radio_brand'
        db.add_column('censo_cuerpomaterialmayorportableradio', 'portable_radio_brand', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'CuerpoMaterialMayorPortableRadio.fk_portable_radio_brand'
        db.delete_column('censo_cuerpomaterialmayorportableradio', 'fk_portable_radio_brand_id')

        # Adding field 'CuerpoMaterialMayorInstalledRadio.installed_radio_brand'
        db.add_column('censo_cuerpomaterialmayorinstalledradio', 'installed_radio_brand', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'CuerpoMaterialMayorInstalledRadio.fk_installed_radio_brand'
        db.delete_column('censo_cuerpomaterialmayorinstalledradio', 'fk_installed_radio_brand_id')
