...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'CuerpoMayorMaterialData', fields ['cuerpo']
        db.delete_unique('censo_cuerpomayormaterialdata', ['cuerpo_id'])

        # Changing field 'CuerpoMayorMaterialData.cuerpo'
        db.alter_column('censo_cuerpomayormaterialdata', 'cuerpo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Cuerpo']))


    def backwards(self, orm):
        
        # Changing field 'CuerpoMayorMaterialData.cuerpo'
        db.alter_column('censo_cuerpomayormaterialdata', 'cuerpo_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['censo.Cuerpo'], unique=True))

        # Adding unique constraint on 'CuerpoMayorMaterialData', fields ['cuerpo']
        db.create_unique('censo_cuerpomayormaterialdata', ['cuerpo_id'])
