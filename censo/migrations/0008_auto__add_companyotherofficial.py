...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompanyOtherOfficial'
        db.create_table('censo_companyotherofficial', (
        ...
        db.send_create_signal('censo', ['CompanyOtherOfficial'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CompanyOtherOfficial'
        db.delete_table('censo_companyotherofficial')
