...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MinorMaterialCompanyData.electricgenerator_portable_potency'
        db.delete_column('censo_minormaterialcompanydata', 'electricgenerator_portable_potency')

        # Deleting field 'MinorMaterialCompanyData.electricgenerator_fixed_in_barracks_potency'
        db.delete_column('censo_minormaterialcompanydata', 'electricgenerator_fixed_in_barracks_potency')

        # Adding field 'MinorMaterialCompanyData.fk_electricgenerator_portable_potency'
        db.add_column('censo_minormaterialcompanydata', 'fk_electricgenerator_portable_potency', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['censo.PotencyRange']), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.fk_electricgenerator_fixed_in_barracks_potency'
        db.add_column('censo_minormaterialcompanydata', 'fk_electricgenerator_fixed_in_barracks_potency', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['censo.PotencyRange']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'MinorMaterialCompanyData.electricgenerator_portable_potency'
        db.add_column('censo_minormaterialcompanydata', 'electricgenerator_portable_potency', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'MinorMaterialCompanyData.electricgenerator_fixed_in_barracks_potency'
        db.add_column('censo_minormaterialcompanydata', 'electricgenerator_fixed_in_barracks_potency', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
