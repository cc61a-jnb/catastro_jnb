...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CuerpoOtherOfficial'
        db.create_table('censo_cuerpootherofficial', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cuerpo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.Cuerpo'])),
        ...
        db.send_create_signal('censo', ['CuerpoOtherOfficial'])


    def backwards(self, orm):
        
        # Deleting model 'CuerpoOtherOfficial'
        db.delete_table('censo_cuerpootherofficial')
