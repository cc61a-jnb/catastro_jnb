...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PortadaCuerpoData.superintendent_name'
        db.add_column('censo_portadacuerpodata', 'superintendent_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.vice_superintendent_name'
        db.add_column('censo_portadacuerpodata', 'vice_superintendent_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.commander_name'
        db.add_column('censo_portadacuerpodata', 'commander_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.second_commander_name'
        db.add_column('censo_portadacuerpodata', 'second_commander_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.third_commander_name'
        db.add_column('censo_portadacuerpodata', 'third_commander_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.forth_commander_name'
        db.add_column('censo_portadacuerpodata', 'forth_commander_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.secretary_name'
        db.add_column('censo_portadacuerpodata', 'secretary_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.treasury_name'
        db.add_column('censo_portadacuerpodata', 'treasury_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'PortadaCuerpoData.intendent_name'
        db.add_column('censo_portadacuerpodata', 'intendent_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PortadaCuerpoData.superintendent_name'
        db.delete_column('censo_portadacuerpodata', 'superintendent_name')

        # Deleting field 'PortadaCuerpoData.vice_superintendent_name'
        db.delete_column('censo_portadacuerpodata', 'vice_superintendent_name')

        # Deleting field 'PortadaCuerpoData.commander_name'
        db.delete_column('censo_portadacuerpodata', 'commander_name')

        # Deleting field 'PortadaCuerpoData.second_commander_name'
        db.delete_column('censo_portadacuerpodata', 'second_commander_name')

        # Deleting field 'PortadaCuerpoData.third_commander_name'
        db.delete_column('censo_portadacuerpodata', 'third_commander_name')

        # Deleting field 'PortadaCuerpoData.forth_commander_name'
        db.delete_column('censo_portadacuerpodata', 'forth_commander_name')

        # Deleting field 'PortadaCuerpoData.secretary_name'
        db.delete_column('censo_portadacuerpodata', 'secretary_name')

        # Deleting field 'PortadaCuerpoData.treasury_name'
        db.delete_column('censo_portadacuerpodata', 'treasury_name')

        # Deleting field 'PortadaCuerpoData.intendent_name'
        db.delete_column('censo_portadacuerpodata', 'intendent_name')
