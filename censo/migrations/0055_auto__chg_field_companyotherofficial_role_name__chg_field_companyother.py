...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyOtherOfficial.role_name'
        db.alter_column('censo_companyotherofficial', 'role_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'CompanyOtherOfficial.person_name'
        db.alter_column('censo_companyotherofficial', 'person_name', self.gf('django.db.models.fields.CharField')(max_length=100))
    
    
    def backwards(self, orm):
        
        # Changing field 'CompanyOtherOfficial.role_name'
        db.alter_column('censo_companyotherofficial', 'role_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'CompanyOtherOfficial.person_name'
        db.alter_column('censo_companyotherofficial', 'person_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))
