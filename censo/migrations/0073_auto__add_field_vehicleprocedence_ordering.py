...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VehicleProcedence.ordering'
        db.add_column('censo_vehicleprocedence', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VehicleProcedence.ordering'
        db.delete_column('censo_vehicleprocedence', 'ordering')
