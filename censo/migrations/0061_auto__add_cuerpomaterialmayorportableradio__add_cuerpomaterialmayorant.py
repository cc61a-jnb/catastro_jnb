...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CuerpoMaterialMayorPortableRadio'
        db.create_table('censo_cuerpomaterialmayorportableradio', (
            ('material_mayor_data', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.CuerpoMayorMaterialData'])),
            ('portable_radio_model', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('portable_radio_quantity', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('portable_radio_brand', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('censo', ['CuerpoMaterialMayorPortableRadio'])

        # Adding model 'CuerpoMaterialMayorAntenna'
        db.create_table('censo_cuerpomaterialmayorantenna', (
            ('antenna_quantity', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('antenna_decibel', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('antenna_model', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('material_mayor_data', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['censo.CuerpoMayorMaterialData'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('antenna_brand', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('censo', ['CuerpoMaterialMayorAntenna'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CuerpoMaterialMayorPortableRadio'
        db.delete_table('censo_cuerpomaterialmayorportableradio')

        # Deleting model 'CuerpoMaterialMayorAntenna'
        db.delete_table('censo_cuerpomaterialmayorantenna')
