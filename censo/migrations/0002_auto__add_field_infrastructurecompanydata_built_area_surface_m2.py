...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InfrastructureCompanyData.built_area_surface_m2'
        db.add_column('censo_infrastructurecompanydata', 'built_area_surface_m2', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'InfrastructureCompanyData.built_area_surface_m2'
        db.delete_column('censo_infrastructurecompanydata', 'built_area_surface_m2')
