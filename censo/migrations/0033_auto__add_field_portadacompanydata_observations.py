...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PortadaCompanyData.observations'
        db.add_column('censo_portadacompanydata', 'observations', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PortadaCompanyData.observations'
        db.delete_column('censo_portadacompanydata', 'observations')
    ...
    models = {
        ...
        'censo.portadacompanydata': {
            ...
            'observations': ('django.db.models.fields.TextField', [], {'default': "''"}),
