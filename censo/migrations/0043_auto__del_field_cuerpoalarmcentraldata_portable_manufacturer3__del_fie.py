...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CuerpoAlarmCentralData.fk_portable_manufacturer2'
        db.add_column('censo_cuerpoalarmcentraldata', 'fk_portable_manufacturer2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['censo.PortableBrand']), keep_default=False)

        # Adding field 'CuerpoAlarmCentralData.fk_portable_manufacturer3'
        db.add_column('censo_cuerpoalarmcentraldata', 'fk_portable_manufacturer3', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['censo.PortableBrand']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CuerpoAlarmCentralData.fk_portable_manufacturer2'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fk_portable_manufacturer2_id')

        # Deleting field 'CuerpoAlarmCentralData.fk_portable_manufacturer3'
        db.delete_column('censo_cuerpoalarmcentraldata', 'fk_portable_manufacturer3_id')
