...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('censo_infrastructurecompanydata', (
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('property_title_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('building_material_type_other', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('terrain_session_room_m2', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
    ...
    models = {
        ...
        'censo.infrastructurecompanydata': {
            ...
            'property_title_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
